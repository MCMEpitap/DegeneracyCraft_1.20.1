...
public class MachineElementProcessorRecipe implements Recipe<SimpleContainer> {
    ...
    public MachineElementProcessorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return MachineElementProcessorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return MachineElementProcessorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<MachineElementProcessorRecipe> {
        public static final MachineElementProcessorRecipe.Type INSTANCE = new MachineElementProcessorRecipe.Type();
        public static final String ID = "machine_element_processor_recipe";
    }

    public static class Serializer implements RecipeSerializer<MachineElementProcessorRecipe> {
        public static final MachineElementProcessorRecipe.Serializer INSTANCE = new MachineElementProcessorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "machine_element_processor_recipe");

        @Override
        public MachineElementProcessorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MachineElementProcessorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable MachineElementProcessorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, MachineElementProcessorRecipe recipe) {
