...
public class ChemicalReactorRecipe implements Recipe<SimpleContainer> {
    ...
    public ChemicalReactorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ChemicalReactorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return ChemicalReactorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<ChemicalReactorRecipe> {
        public static final ChemicalReactorRecipe.Type INSTANCE = new ChemicalReactorRecipe.Type();
    ...
    public static class Serializer implements RecipeSerializer<ChemicalReactorRecipe> {
        public static final ChemicalReactorRecipe.Serializer INSTANCE = new ChemicalReactorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "chemical_reactor_recipe");
        ...
        public ChemicalReactorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ChemicalReactorRecipe(id, energy, time, phase, inputs, outputs);
        }
