...
public class BioReactorRecipe implements Recipe<SimpleContainer> {
    ...
    public BioReactorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return BioReactorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return BioReactorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<BioReactorRecipe> {
        public static final BioReactorRecipe.Type INSTANCE = new BioReactorRecipe.Type();
        public static final String ID = "bio_reactor_recipe";
    }

    public static class Serializer implements RecipeSerializer<BioReactorRecipe> {
        public static final BioReactorRecipe.Serializer INSTANCE = new BioReactorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "bio_reactor_recipe");

        @Override
        public BioReactorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BioReactorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable BioReactorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, BioReactorRecipe recipe) {
