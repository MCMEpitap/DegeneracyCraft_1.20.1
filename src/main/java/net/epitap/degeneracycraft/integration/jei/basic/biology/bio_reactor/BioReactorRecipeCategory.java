package net.epitap.degeneracycraft.integration.jei.basic.biology.bio_reactor;
...
public class BioReactorRecipeCategory implements IRecipeCategory<BioReactorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "bio_reactor_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/biology/low_performance_bio_reactor/low_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/biology/medium_performance_bio_reactor/medium_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/biology/high_performance_bio_reactor/high_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/biology/super_performance_bio_reactor/super_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/biology/over_performance_bio_reactor/over_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/biology/ultra_performance_bio_reactor/ultra_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/biology/anti_performance_bio_reactor/anti_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/biology/imaginary_performance_bio_reactor/imaginary_performance_bio_reactor_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/biology/infinity_performance_bio_reactor/infinity_performance_bio_reactor_uid.png");
    ...
    public BasicPerformanceBioReactorMenu menu;
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_bio_reactor");
    }
    ...
    public static final RecipeType<BioReactorRecipe> TYPE =
            new RecipeType<>(UID, BioReactorRecipe.class);


    @Override
    public void draw(BioReactorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(BioReactorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(BioReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BioReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BioReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(BioReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull BioReactorRecipe recipe,
