package net.epitap.degeneracycraft.integration.jei.basic.astronomy.starlight_collector;
...
public class StarlightCollectorRecipeCategory implements IRecipeCategory<StarlightCollectorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "starlight_collector_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/astronomy/low_performance_starlight_collector/low_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/astronomy/medium_performance_starlight_collector/medium_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/astronomy/high_performance_starlight_collector/high_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/astronomy/super_performance_starlight_collector/super_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/astronomy/over_performance_starlight_collector/over_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/astronomy/ultra_performance_starlight_collector/ultra_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/astronomy/anti_performance_starlight_collector/anti_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/astronomy/imaginary_performance_starlight_collector/imaginary_performance_starlight_collector_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/astronomy/infinity_performance_starlight_collector/infinity_performance_starlight_collector_uid.png");
    ...
    public BasicPerformanceStarlightCollectorMenu menu;

    public StarlightCollectorRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_starlight_collector");
    }
    ...
    public static final RecipeType<StarlightCollectorRecipe> TYPE =
            new RecipeType<>(UID, StarlightCollectorRecipe.class);


    @Override
    public void draw(StarlightCollectorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(StarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(StarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(StarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(StarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(StarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull StarlightCollectorRecipe recipe,
