...
public class BasicPerformanceMachineDataInstallerRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceMachineDataInstallerMenu, BasicPerformanceMachineDataInstallerRecipe> {
    ...
    public BasicPerformanceMachineDataInstallerRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicPerformanceMachineDataInstallerRecipe recipe, boolean maxTransfer) {
