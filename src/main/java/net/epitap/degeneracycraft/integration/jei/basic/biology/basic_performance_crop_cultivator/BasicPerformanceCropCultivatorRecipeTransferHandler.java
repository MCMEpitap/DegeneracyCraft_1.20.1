...
public class BasicPerformanceCropCultivatorRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCropCultivatorMenu, BasicPerformanceCropCultivatorRecipe> {
    ...
    public BasicPerformanceCropCultivatorRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicPerformanceCropCultivatorRecipe recipe, boolean maxTransfer) {
