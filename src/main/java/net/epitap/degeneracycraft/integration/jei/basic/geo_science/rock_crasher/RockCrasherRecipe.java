...
public class RockCrasherRecipe implements Recipe<SimpleContainer> {
    ...
    public RockCrasherRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return RockCrasherRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return RockCrasherRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<RockCrasherRecipe> {
        public static final RockCrasherRecipe.Type INSTANCE = new RockCrasherRecipe.Type();
        public static final String ID = "rock_crasher_recipe";
    }

    public static class Serializer implements RecipeSerializer<RockCrasherRecipe> {
        public static final RockCrasherRecipe.Serializer INSTANCE = new RockCrasherRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "rock_crasher_recipe");

        @Override
        public RockCrasherRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new RockCrasherRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable RockCrasherRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, RockCrasherRecipe recipe) {
