...
public class BasicPerformanceStarlightCollectorRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceStarlightCollectorMenu, BasicPerformanceStarlightCollectorRecipe> {
    ...
    public BasicPerformanceStarlightCollectorRecipeTransferHandler(
    ...
    public RecipeType<BasicPerformanceStarlightCollectorRecipe> getRecipeType() {
        return BasicPerformanceStarlightCollectorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicPerformanceStarlightCollectorRecipe recipe, boolean maxTransfer) {
