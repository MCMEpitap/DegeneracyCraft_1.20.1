...
public class ElectromagneticInductorRecipe implements Recipe<SimpleContainer> {
    ...
    public ElectromagneticInductorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ElectromagneticInductorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return ElectromagneticInductorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<ElectromagneticInductorRecipe> {
        public static final ElectromagneticInductorRecipe.Type INSTANCE = new ElectromagneticInductorRecipe.Type();
        public static final String ID = "electromagnetic_inductor_recipe";
    }

    public static class Serializer implements RecipeSerializer<ElectromagneticInductorRecipe> {
        public static final ElectromagneticInductorRecipe.Serializer INSTANCE = new ElectromagneticInductorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "electromagnetic_inductor_recipe");

        @Override
        public ElectromagneticInductorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ElectromagneticInductorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable ElectromagneticInductorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, ElectromagneticInductorRecipe recipe) {
