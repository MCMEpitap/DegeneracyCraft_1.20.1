...
public class ElectrolyserRecipe implements Recipe<SimpleContainer> {
    ...
    public ElectrolyserRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ElectrolyserRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return ElectrolyserRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<ElectrolyserRecipe> {
        public static final ElectrolyserRecipe.Type INSTANCE = new ElectrolyserRecipe.Type();
        public static final String ID = "electrolyser_recipe";
    }

    public static class Serializer implements RecipeSerializer<ElectrolyserRecipe> {
        public static final ElectrolyserRecipe.Serializer INSTANCE = new ElectrolyserRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "electrolyser_recipe");

        @Override
        public ElectrolyserRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ElectrolyserRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable ElectrolyserRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, ElectrolyserRecipe recipe) {
