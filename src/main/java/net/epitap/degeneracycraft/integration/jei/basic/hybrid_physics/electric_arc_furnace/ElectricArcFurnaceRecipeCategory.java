package net.epitap.degeneracycraft.integration.jei.basic.hybrid_physics.electric_arc_furnace;
...
public class ElectricArcFurnaceRecipeCategory implements IRecipeCategory<ElectricArcFurnaceRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "electric_arc_furnace_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/hybrid_physics/low_performance_electric_arc_furnace/low_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/hybrid_physics/medium_performance_electric_arc_furnace/medium_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/hybrid_physics/high_performance_electric_arc_furnace/high_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/hybrid_physics/super_performance_electric_arc_furnace/super_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/hybrid_physics/over_performance_electric_arc_furnace/over_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/hybrid_physics/ultra_performance_electric_arc_furnace/ultra_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/hybrid_physics/anti_performance_electric_arc_furnace/anti_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/hybrid_physics/imaginary_performance_electric_arc_furnace/imaginary_performance_electric_arc_furnace_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/hybrid_physics/infinity_performance_electric_arc_furnace/infinity_performance_electric_arc_furnace_uid.png");
    ...
    public BasicPerformanceElectricArcFurnaceMenu menu;
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_electric_arc_furnace");
    }
    ...
    public static final RecipeType<ElectricArcFurnaceRecipe> TYPE =
            new RecipeType<>(UID, ElectricArcFurnaceRecipe.class);


    @Override
    public void draw(ElectricArcFurnaceRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(ElectricArcFurnaceRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(ElectricArcFurnaceRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(ElectricArcFurnaceRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(ElectricArcFurnaceRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(ElectricArcFurnaceRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull ElectricArcFurnaceRecipe recipe,
