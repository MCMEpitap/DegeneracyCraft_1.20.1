...
public class AstronomicalTelescopeRecipe implements Recipe<SimpleContainer> {
    ...
    public AstronomicalTelescopeRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return AstronomicalTelescopeRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return AstronomicalTelescopeRecipe.Type.INSTANCE;
    }
    ...
    public static class Serializer implements RecipeSerializer<AstronomicalTelescopeRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "astronomical_telescope_recipe");

        @Override
        public AstronomicalTelescopeRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new AstronomicalTelescopeRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable AstronomicalTelescopeRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, AstronomicalTelescopeRecipe recipe) {
