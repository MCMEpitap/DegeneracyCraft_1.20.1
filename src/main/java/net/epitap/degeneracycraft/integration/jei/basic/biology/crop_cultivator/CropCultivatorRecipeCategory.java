package net.epitap.degeneracycraft.integration.jei.basic.biology.crop_cultivator;
...
public class CropCultivatorRecipeCategory implements IRecipeCategory<CropCultivatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "crop_cultivator_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/biology/low_performance_crop_cultivator/low_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/biology/medium_performance_crop_cultivator/medium_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/biology/high_performance_crop_cultivator/high_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/biology/super_performance_crop_cultivator/super_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/biology/over_performance_crop_cultivator/over_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/biology/ultra_performance_crop_cultivator/ultra_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/biology/anti_performance_crop_cultivator/anti_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/biology/imaginary_performance_crop_cultivator/imaginary_performance_crop_cultivator_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/biology/infinity_performance_crop_cultivator/infinity_performance_crop_cultivator_uid.png");
    ...
    public BasicPerformanceCropCultivatorMenu menu;

    public CropCultivatorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<CropCultivatorRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_crop_cultivator");
    }
    ...
    public static final RecipeType<CropCultivatorRecipe> TYPE =
            new RecipeType<>(UID, CropCultivatorRecipe.class);


    @Override
    public void draw(CropCultivatorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(CropCultivatorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(CropCultivatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(CropCultivatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(CropCultivatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(CropCultivatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull CropCultivatorRecipe recipe,
