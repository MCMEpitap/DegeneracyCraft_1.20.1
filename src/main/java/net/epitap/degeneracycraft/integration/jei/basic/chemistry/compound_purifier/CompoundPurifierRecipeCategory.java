package net.epitap.degeneracycraft.integration.jei.basic.chemistry.compound_purifier;
...
public class CompoundPurifierRecipeCategory implements IRecipeCategory<CompoundPurifierRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "compound_purifier_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/chemistry/low_performance_compound_purifier/low_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/chemistry/medium_performance_compound_purifier/medium_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/chemistry/high_performance_compound_purifier/high_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/chemistry/super_performance_compound_purifier/super_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/chemistry/over_performance_compound_purifier/over_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/chemistry/ultra_performance_compound_purifier/ultra_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/chemistry/anti_performance_compound_purifier/anti_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/chemistry/imaginary_performance_compound_purifier/imaginary_performance_compound_purifier_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/chemistry/infinity_performance_compound_purifier/infinity_performance_compound_purifier_uid.png");
    ...
    public BasicPerformanceCompoundPurifierMenu menu;

    public CompoundPurifierRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<CompoundPurifierRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_compound_purifier");
    }
    ...
    public static final RecipeType<CompoundPurifierRecipe> TYPE =
            new RecipeType<>(UID, CompoundPurifierRecipe.class);


    @Override
    public void draw(CompoundPurifierRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(CompoundPurifierRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(CompoundPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(CompoundPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(CompoundPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(CompoundPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull CompoundPurifierRecipe recipe,
