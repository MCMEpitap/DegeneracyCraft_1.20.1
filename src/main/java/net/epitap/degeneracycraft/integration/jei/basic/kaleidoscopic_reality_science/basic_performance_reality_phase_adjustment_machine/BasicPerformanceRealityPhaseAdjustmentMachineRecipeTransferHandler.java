...
public class BasicPerformanceRealityPhaseAdjustmentMachineRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceRealityPhaseAdjustmentMachineMenu, BasicPerformanceRealityPhaseAdjustmentMachineRecipe> {
    ...
    public BasicPerformanceRealityPhaseAdjustmentMachineRecipeTransferHandler(
    ...
    public RecipeType<BasicPerformanceRealityPhaseAdjustmentMachineRecipe> getRecipeType() {
        return BasicPerformanceRealityPhaseAdjustmentMachineRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicPerformanceRealityPhaseAdjustmentMachineRecipe recipe, boolean maxTransfer) {
