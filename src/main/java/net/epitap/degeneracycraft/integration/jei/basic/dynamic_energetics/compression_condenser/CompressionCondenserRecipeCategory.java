package net.epitap.degeneracycraft.integration.jei.basic.dynamic_energetics.compression_condenser;
...
public class CompressionCondenserRecipeCategory implements IRecipeCategory<CompressionCondenserRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "compression_condenser_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/dynamic_energetics/low_technology_compression_condenser/low_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/dynamic_energetics/medium_technology_compression_condenser/medium_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/dynamic_energetics/high_technology_compression_condenser/high_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/dynamic_energetics/super_technology_compression_condenser/super_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/dynamic_energetics/over_technology_compression_condenser/over_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/dynamic_energetics/ultra_technology_compression_condenser/ultra_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/dynamic_energetics/anti_technology_compression_condenser/anti_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/dynamic_energetics/imaginary_technology_compression_condenser/imaginary_technology_compression_condenser_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/dynamic_energetics/infinity_technology_compression_condenser/infinity_technology_compression_condenser_uid.png");
    ...
    public BasicTechnologyCompressionCondenserMenu menu;

    public CompressionCondenserRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<CompressionCondenserRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_compression_condenser");
    }
    ...
    public static final RecipeType<CompressionCondenserRecipe> TYPE =
            new RecipeType<>(UID, CompressionCondenserRecipe.class);


    @Override
    public void draw(CompressionCondenserRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(CompressionCondenserRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(CompressionCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(CompressionCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(CompressionCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(CompressionCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull CompressionCondenserRecipe recipe,
