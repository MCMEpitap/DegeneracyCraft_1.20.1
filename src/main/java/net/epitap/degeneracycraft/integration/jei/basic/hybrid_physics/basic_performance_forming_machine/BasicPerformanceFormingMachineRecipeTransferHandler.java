...
public class BasicPerformanceFormingMachineRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceFormingMachineMenu, BasicPerformanceFormingMachineRecipe> {
    ...
    public BasicPerformanceFormingMachineRecipeTransferHandler(
    ...
    @Override
    public RecipeType<BasicPerformanceFormingMachineRecipe> getRecipeType() {
        return BasicPerformanceFormingMachineRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicPerformanceFormingMachineRecipe recipe, boolean maxTransfer) {
