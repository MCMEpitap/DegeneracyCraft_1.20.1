...
public class BasicPerformanceAstronomicalTelescopeRecipeCategory implements IRecipeCategory<BasicPerformanceAstronomicalTelescopeRecipe> {
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceAstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
...
//        guiGraphics.drawString(fontRenderer, (recipe.getRequiredEnergy() / recipe.getRequiredTime() / 20F + " FE/t"), 17, 117, 0xFFFFFF);
    ...
    protected void drawRequiredTime(BasicPerformanceAstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(BasicPerformanceAstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
