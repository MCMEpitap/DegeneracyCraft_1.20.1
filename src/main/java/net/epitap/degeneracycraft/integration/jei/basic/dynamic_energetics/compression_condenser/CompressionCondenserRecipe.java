...
public class CompressionCondenserRecipe implements Recipe<SimpleContainer> {
    ...
    public CompressionCondenserRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return CompressionCondenserRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return CompressionCondenserRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<CompressionCondenserRecipe> {
        public static final CompressionCondenserRecipe.Type INSTANCE = new CompressionCondenserRecipe.Type();
        public static final String ID = "compression_condenser_recipe";
    }

    public static class Serializer implements RecipeSerializer<CompressionCondenserRecipe> {
        public static final CompressionCondenserRecipe.Serializer INSTANCE = new CompressionCondenserRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "compression_condenser_recipe");

        @Override
        public CompressionCondenserRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CompressionCondenserRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable CompressionCondenserRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, CompressionCondenserRecipe recipe) {
