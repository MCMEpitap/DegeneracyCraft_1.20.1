...
public class BasicTechnologyMachineElementProcessorRecipeTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyMachineElementProcessorMenu, BasicTechnologyMachineElementProcessorRecipe> {
    ...
    public BasicTechnologyMachineElementProcessorRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicTechnologyMachineElementProcessorRecipe recipe, boolean maxTransfer) {
