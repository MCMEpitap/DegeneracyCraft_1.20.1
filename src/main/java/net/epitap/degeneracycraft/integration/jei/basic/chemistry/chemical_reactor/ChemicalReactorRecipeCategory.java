package net.epitap.degeneracycraft.integration.jei.basic.chemistry.chemical_reactor;
...
public class ChemicalReactorRecipeCategory implements IRecipeCategory<ChemicalReactorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "chemical_reactor_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/chemistry/low_performance_chemical_reactor/low_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/chemistry/medium_performance_chemical_reactor/medium_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/chemistry/high_performance_chemical_reactor/high_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/chemistry/super_performance_chemical_reactor/super_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/chemistry/over_performance_chemical_reactor/over_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/chemistry/ultra_performance_chemical_reactor/ultra_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/chemistry/anti_performance_chemical_reactor/anti_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/chemistry/imaginary_performance_chemical_reactor/imaginary_performance_chemical_reactor_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/chemistry/infinity_performance_chemical_reactor/infinity_performance_chemical_reactor_uid.png");
    ...
    public BasicPerformanceChemicalReactorMenu menu;

    public ChemicalReactorRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_chemical_reactor");
    }
    ...
    @Override
    public void draw(ChemicalReactorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(ChemicalReactorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(ChemicalReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(ChemicalReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(ChemicalReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(ChemicalReactorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull ChemicalReactorRecipe recipe,
