package net.epitap.degeneracycraft.integration.jei.basic.geo_science.ore_sorter;
...
public class OreSorterRecipeCategory implements IRecipeCategory<OreSorterRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "ore_sorter_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/geo_science/low_performance_ore_sorter/low_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/geo_science/medium_performance_ore_sorter/medium_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/geo_science/high_performance_ore_sorter/high_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/geo_science/super_performance_ore_sorter/super_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/geo_science/over_performance_ore_sorter/over_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/geo_science/ultra_performance_ore_sorter/ultra_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/geo_science/anti_performance_ore_sorter/anti_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/geo_science/imaginary_performance_ore_sorter/imaginary_performance_ore_sorter_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/geo_science/infinity_performance_ore_sorter/infinity_performance_ore_sorter_uid.png");
    ...
    public BasicPerformanceOreSorterMenu menu;

    public OreSorterRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<OreSorterRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_ore_sorter");
    }
    ...
    public static final RecipeType<OreSorterRecipe> TYPE =
            new RecipeType<>(UID, OreSorterRecipe.class);


    @Override
    public void draw(OreSorterRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(OreSorterRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(OreSorterRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(OreSorterRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(OreSorterRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(OreSorterRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull OreSorterRecipe recipe,
