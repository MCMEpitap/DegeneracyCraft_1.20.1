...
public class OreSorterRecipe implements Recipe<SimpleContainer> {
    ...
    public OreSorterRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return OreSorterRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return OreSorterRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<OreSorterRecipe> {
        public static final OreSorterRecipe.Type INSTANCE = new OreSorterRecipe.Type();
        public static final String ID = "ore_sorter_recipe";
    }

    public static class Serializer implements RecipeSerializer<OreSorterRecipe> {
        public static final OreSorterRecipe.Serializer INSTANCE = new OreSorterRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "ore_sorter_recipe");

        @Override
        public OreSorterRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new OreSorterRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable OreSorterRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, OreSorterRecipe recipe) {
