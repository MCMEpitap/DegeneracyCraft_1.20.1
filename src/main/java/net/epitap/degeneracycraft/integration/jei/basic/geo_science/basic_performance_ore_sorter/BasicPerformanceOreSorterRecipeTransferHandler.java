...
public class BasicPerformanceOreSorterRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceOreSorterMenu, BasicPerformanceOreSorterRecipe> {
    ...
    public BasicPerformanceOreSorterRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicPerformanceOreSorterRecipe recipe, boolean maxTransfer) {
