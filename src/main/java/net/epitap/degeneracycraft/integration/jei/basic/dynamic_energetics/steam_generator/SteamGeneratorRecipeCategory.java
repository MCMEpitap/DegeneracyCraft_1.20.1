package net.epitap.degeneracycraft.integration.jei.basic.dynamic_energetics.steam_generator;
...
public class SteamGeneratorRecipeCategory implements IRecipeCategory<SteamGeneratorRecipe> {
    ...
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/basic/dynamic_energetics/basic_power_steam_generator/basic_power_steam_generator_uid.png");
    BasicPowerSteamGeneratorBlockEntity blockEntity;
    private final IDrawable background;
    private final IDrawable icon;

    public SteamGeneratorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<SteamGeneratorRecipe> getRecipeType() {
        return TYPE;
    }
    ...
    public static final RecipeType<SteamGeneratorRecipe> TYPE =
            new RecipeType<>(UID, SteamGeneratorRecipe.class);

    @Override
    public void draw(SteamGeneratorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(SteamGeneratorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(SteamGeneratorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(SteamGeneratorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, SteamGeneratorRecipe recipe, IFocusGroup focusGroup) {
