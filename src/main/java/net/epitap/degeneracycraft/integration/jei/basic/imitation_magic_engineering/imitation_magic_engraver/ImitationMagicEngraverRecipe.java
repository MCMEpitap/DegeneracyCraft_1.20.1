...
public class ImitationMagicEngraverRecipe implements Recipe<SimpleContainer> {
    ...
    public ImitationMagicEngraverRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ImitationMagicEngraverRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return ImitationMagicEngraverRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<ImitationMagicEngraverRecipe> {
        public static final ImitationMagicEngraverRecipe.Type INSTANCE = new ImitationMagicEngraverRecipe.Type();
        public static final String ID = "imitation_magic_engraver_recipe";
    }

    public static class Serializer implements RecipeSerializer<ImitationMagicEngraverRecipe> {
        public static final ImitationMagicEngraverRecipe.Serializer INSTANCE = new ImitationMagicEngraverRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "imitation_magic_engraver_recipe");

        @Override
        public ImitationMagicEngraverRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ImitationMagicEngraverRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable ImitationMagicEngraverRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, ImitationMagicEngraverRecipe recipe) {
