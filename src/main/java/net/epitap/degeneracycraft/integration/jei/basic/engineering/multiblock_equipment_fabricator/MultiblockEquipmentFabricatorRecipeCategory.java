package net.epitap.degeneracycraft.integration.jei.basic.engineering.multiblock_equipment_fabricator;
...
public class MultiblockEquipmentFabricatorRecipeCategory implements IRecipeCategory<MultiblockEquipmentFabricatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "multiblock_equipment_fabricator_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/engineering/low_technology_multiblock_equipment_fabricator/low_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/engineering/medium_technology_multiblock_equipment_fabricator/medium_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/engineering/high_technology_multiblock_equipment_fabricator/high_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/engineering/super_technology_multiblock_equipment_fabricator/super_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/engineering/over_technology_multiblock_equipment_fabricator/over_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/engineering/ultra_technology_multiblock_equipment_fabricator/ultra_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/engineering/anti_technology_multiblock_equipment_fabricator/anti_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/engineering/imaginary_technology_multiblock_equipment_fabricator/imaginary_technology_multiblock_equipment_fabricator_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/engineering/infinity_technology_multiblock_equipment_fabricator/infinity_technology_multiblock_equipment_fabricator_uid.png");
    ...
    public BasicTechnologyMultiblockEquipmentFabricatorMenu menu;

    public MultiblockEquipmentFabricatorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<MultiblockEquipmentFabricatorRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_multiblock_equipment_fabricator");
    }
    ...
    public static final RecipeType<MultiblockEquipmentFabricatorRecipe> TYPE =
            new RecipeType<>(UID, MultiblockEquipmentFabricatorRecipe.class);


    @Override
    public void draw(MultiblockEquipmentFabricatorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(MultiblockEquipmentFabricatorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(MultiblockEquipmentFabricatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(MultiblockEquipmentFabricatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(MultiblockEquipmentFabricatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(MultiblockEquipmentFabricatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull MultiblockEquipmentFabricatorRecipe recipe,
