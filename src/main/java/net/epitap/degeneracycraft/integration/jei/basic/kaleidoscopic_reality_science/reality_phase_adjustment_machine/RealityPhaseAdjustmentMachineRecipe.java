...
public class RealityPhaseAdjustmentMachineRecipe implements Recipe<SimpleContainer> {
    ...
    public RealityPhaseAdjustmentMachineRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return RealityPhaseAdjustmentMachineRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return RealityPhaseAdjustmentMachineRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<RealityPhaseAdjustmentMachineRecipe> {
        public static final RealityPhaseAdjustmentMachineRecipe.Type INSTANCE = new RealityPhaseAdjustmentMachineRecipe.Type();
        public static final String ID = "reality_phase_adjustment_machine_recipe";
    }

    public static class Serializer implements RecipeSerializer<RealityPhaseAdjustmentMachineRecipe> {
        public static final RealityPhaseAdjustmentMachineRecipe.Serializer INSTANCE = new RealityPhaseAdjustmentMachineRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "reality_phase_adjustment_machine_recipe");

        @Override
        public RealityPhaseAdjustmentMachineRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new RealityPhaseAdjustmentMachineRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable RealityPhaseAdjustmentMachineRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, RealityPhaseAdjustmentMachineRecipe recipe) {
