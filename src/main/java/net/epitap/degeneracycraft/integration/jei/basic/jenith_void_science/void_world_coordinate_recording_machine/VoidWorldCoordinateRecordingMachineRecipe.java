...
public class VoidWorldCoordinateRecordingMachineRecipe implements Recipe<SimpleContainer> {
    ...
    public VoidWorldCoordinateRecordingMachineRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return VoidWorldCoordinateRecordingMachineRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return VoidWorldCoordinateRecordingMachineRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<VoidWorldCoordinateRecordingMachineRecipe> {
        public static final VoidWorldCoordinateRecordingMachineRecipe.Type INSTANCE = new VoidWorldCoordinateRecordingMachineRecipe.Type();
        public static final String ID = "void_world_coordinate_recording_machine_recipe";
    }

    public static class Serializer implements RecipeSerializer<VoidWorldCoordinateRecordingMachineRecipe> {
        public static final VoidWorldCoordinateRecordingMachineRecipe.Serializer INSTANCE = new VoidWorldCoordinateRecordingMachineRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "void_world_coordinate_recording_machine_recipe");

        @Override
        public VoidWorldCoordinateRecordingMachineRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new VoidWorldCoordinateRecordingMachineRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable VoidWorldCoordinateRecordingMachineRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, VoidWorldCoordinateRecordingMachineRecipe recipe) {
