package net.epitap.degeneracycraft.integration.jei.basic.hybrid_physics.material_separator;
...
public class MaterialSeparatorRecipeCategory implements IRecipeCategory<MaterialSeparatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "material_separator_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/hybrid_physics/low_performance_material_separator/low_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/hybrid_physics/medium_performance_material_separator/medium_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/hybrid_physics/high_performance_material_separator/high_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/hybrid_physics/super_performance_material_separator/super_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/hybrid_physics/over_performance_material_separator/over_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/hybrid_physics/ultra_performance_material_separator/ultra_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/hybrid_physics/anti_performance_material_separator/anti_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/hybrid_physics/imaginary_performance_material_separator/imaginary_performance_material_separator_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/hybrid_physics/infinity_performance_material_separator/infinity_performance_material_separator_uid.png");
    ...
    public BasicPerformanceMaterialSeparatorMenu menu;

    public MaterialSeparatorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<MaterialSeparatorRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_material_separator");
    }
    ...
    public static final RecipeType<MaterialSeparatorRecipe> TYPE =
            new RecipeType<>(UID, MaterialSeparatorRecipe.class);


    @Override
    public void draw(MaterialSeparatorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(MaterialSeparatorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(MaterialSeparatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(MaterialSeparatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(MaterialSeparatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(MaterialSeparatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull MaterialSeparatorRecipe recipe,
