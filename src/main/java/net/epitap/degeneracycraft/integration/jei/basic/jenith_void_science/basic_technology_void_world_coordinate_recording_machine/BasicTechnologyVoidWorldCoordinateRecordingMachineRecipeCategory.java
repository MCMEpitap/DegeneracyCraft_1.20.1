...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineRecipeCategory implements IRecipeCategory<BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_basic_technology_void_world_coordinate_recording_machine");
    }
    ...
    @Override
    public void draw(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyVoidWorldCoordinateRecordingMachineRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
