...
public class CropCultivatorRecipe implements Recipe<SimpleContainer> {
    ...
    public CropCultivatorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return CropCultivatorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return CropCultivatorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<CropCultivatorRecipe> {
        public static final CropCultivatorRecipe.Type INSTANCE = new CropCultivatorRecipe.Type();
        public static final String ID = "crop_cultivator_recipe";
    }

    public static class Serializer implements RecipeSerializer<CropCultivatorRecipe> {
        public static final CropCultivatorRecipe.Serializer INSTANCE = new CropCultivatorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "crop_cultivator_recipe");

        @Override
        public CropCultivatorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CropCultivatorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable CropCultivatorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, CropCultivatorRecipe recipe) {
