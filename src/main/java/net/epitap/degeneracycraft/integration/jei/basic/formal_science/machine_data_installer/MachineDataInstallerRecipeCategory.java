package net.epitap.degeneracycraft.integration.jei.basic.formal_science.machine_data_installer;
...
public class MachineDataInstallerRecipeCategory implements IRecipeCategory<MachineDataInstallerRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "machine_data_installer_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/formal_science/low_performance_machine_data_installer/low_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/formal_science/medium_performance_machine_data_installer/medium_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/formal_science/high_performance_machine_data_installer/high_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/formal_science/super_performance_machine_data_installer/super_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/formal_science/over_performance_machine_data_installer/over_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/formal_science/ultra_performance_machine_data_installer/ultra_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/formal_science/anti_performance_machine_data_installer/anti_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/formal_science/imaginary_performance_machine_data_installer/imaginary_performance_machine_data_installer_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/formal_science/infinity_performance_machine_data_installer/infinity_performance_machine_data_installer_uid.png");
    ...
    public BasicPerformanceMachineDataInstallerMenu menu;

    public MachineDataInstallerRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<MachineDataInstallerRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_machine_data_installer");
    }
    ...
    public static final RecipeType<MachineDataInstallerRecipe> TYPE =
            new RecipeType<>(UID, MachineDataInstallerRecipe.class);


    @Override
    public void draw(MachineDataInstallerRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(MachineDataInstallerRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(MachineDataInstallerRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(MachineDataInstallerRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(MachineDataInstallerRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(MachineDataInstallerRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull MachineDataInstallerRecipe recipe,
