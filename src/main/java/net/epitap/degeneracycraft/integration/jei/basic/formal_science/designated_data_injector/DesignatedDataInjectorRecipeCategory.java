package net.epitap.degeneracycraft.integration.jei.basic.formal_science.designated_data_injector;
...
public class DesignatedDataInjectorRecipeCategory implements IRecipeCategory<DesignatedDataInjectorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "designated_data_injector_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/formal_science/low_performance_designated_data_injector/low_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/formal_science/medium_performance_designated_data_injector/medium_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/formal_science/high_performance_designated_data_injector/high_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/formal_science/super_performance_designated_data_injector/super_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/formal_science/over_performance_designated_data_injector/over_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/formal_science/ultra_performance_designated_data_injector/ultra_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/formal_science/anti_performance_designated_data_injector/anti_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/formal_science/imaginary_performance_designated_data_injector/imaginary_performance_designated_data_injector_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/formal_science/infinity_performance_designated_data_injector/infinity_performance_designated_data_injector_uid.png");
    ...
    public BasicPerformanceDesignatedDataInjectorMenu menu;

    public DesignatedDataInjectorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<DesignatedDataInjectorRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_designated_data_injector");
    }
    ...
    public static final RecipeType<DesignatedDataInjectorRecipe> TYPE =
            new RecipeType<>(UID, DesignatedDataInjectorRecipe.class);


    @Override
    public void draw(DesignatedDataInjectorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(DesignatedDataInjectorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(DesignatedDataInjectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(DesignatedDataInjectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(DesignatedDataInjectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(DesignatedDataInjectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull DesignatedDataInjectorRecipe recipe,
