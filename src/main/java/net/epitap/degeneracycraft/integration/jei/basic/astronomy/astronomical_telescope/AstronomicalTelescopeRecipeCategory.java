...
public class AstronomicalTelescopeRecipeCategory implements IRecipeCategory<AstronomicalTelescopeRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "astronomical_telescope_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/astronomy/low_performance_astronomical_telescope/low_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/astronomy/medium_performance_astronomical_telescope/medium_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/astronomy/high_performance_astronomical_telescope/high_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/astronomy/super_performance_astronomical_telescope/super_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/astronomy/over_performance_astronomical_telescope/over_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/astronomy/ultra_performance_astronomical_telescope/ultra_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/astronomy/anti_performance_astronomical_telescope/anti_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/astronomy/imaginary_performance_astronomical_telescope/imaginary_performance_astronomical_telescope_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/astronomy/infinity_performance_astronomical_telescope/infinity_performance_astronomical_telescope_uid.png");
    ...
    public BasicPerformanceAstronomicalTelescopeMenu menu;

    public AstronomicalTelescopeRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_astronomical_telescope");
    }
    ...
    public static final RecipeType<AstronomicalTelescopeRecipe> TYPE =
            new RecipeType<>(UID, AstronomicalTelescopeRecipe.class);


    @Override
    public void draw(AstronomicalTelescopeRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(AstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(AstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(AstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(AstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(AstronomicalTelescopeRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull AstronomicalTelescopeRecipe recipe,
