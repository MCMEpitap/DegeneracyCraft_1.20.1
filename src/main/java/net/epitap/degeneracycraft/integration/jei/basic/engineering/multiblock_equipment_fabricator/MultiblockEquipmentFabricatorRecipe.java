...
public class MultiblockEquipmentFabricatorRecipe implements Recipe<SimpleContainer> {
    ...
    public MultiblockEquipmentFabricatorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return MultiblockEquipmentFabricatorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return MultiblockEquipmentFabricatorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<MultiblockEquipmentFabricatorRecipe> {
        public static final MultiblockEquipmentFabricatorRecipe.Type INSTANCE = new MultiblockEquipmentFabricatorRecipe.Type();
        public static final String ID = "multiblock_equipment_fabricator_recipe";
    }

    public static class Serializer implements RecipeSerializer<MultiblockEquipmentFabricatorRecipe> {
        public static final MultiblockEquipmentFabricatorRecipe.Serializer INSTANCE = new MultiblockEquipmentFabricatorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "multiblock_equipment_fabricator_recipe");

        @Override
        public MultiblockEquipmentFabricatorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MultiblockEquipmentFabricatorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable MultiblockEquipmentFabricatorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, MultiblockEquipmentFabricatorRecipe recipe) {
