...
public class SoilPurifierRecipe implements Recipe<SimpleContainer> {
    ...
    public SoilPurifierRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return SoilPurifierRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return SoilPurifierRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<SoilPurifierRecipe> {
        public static final SoilPurifierRecipe.Type INSTANCE = new SoilPurifierRecipe.Type();
        public static final String ID = "soil_purifier_recipe";
    }

    public static class Serializer implements RecipeSerializer<SoilPurifierRecipe> {
        public static final SoilPurifierRecipe.Serializer INSTANCE = new SoilPurifierRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "soil_purifier_recipe");

        @Override
        public SoilPurifierRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new SoilPurifierRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable SoilPurifierRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, SoilPurifierRecipe recipe) {
