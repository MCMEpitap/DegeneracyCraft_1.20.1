package net.epitap.degeneracycraft.integration.jei.basic.geo_science.soil_purifier;
...
public class SoilPurifierRecipeCategory implements IRecipeCategory<SoilPurifierRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "soil_purifier_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/geo_science/low_performance_soil_purifier/low_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/geo_science/medium_performance_soil_purifier/medium_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/geo_science/high_performance_soil_purifier/high_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/geo_science/super_performance_soil_purifier/super_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/geo_science/over_performance_soil_purifier/over_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/geo_science/ultra_performance_soil_purifier/ultra_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/geo_science/anti_performance_soil_purifier/anti_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/geo_science/imaginary_performance_soil_purifier/imaginary_performance_soil_purifier_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/geo_science/infinity_performance_soil_purifier/infinity_performance_soil_purifier_uid.png");
    ...
    public BasicPerformanceSoilPurifierMenu menu;

    public SoilPurifierRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<SoilPurifierRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_soil_purifier");
    }
    ...
    public static final RecipeType<SoilPurifierRecipe> TYPE =
            new RecipeType<>(UID, SoilPurifierRecipe.class);


    @Override
    public void draw(SoilPurifierRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(SoilPurifierRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergyUsage(SoilPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(SoilPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(SoilPurifierRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull SoilPurifierRecipe recipe,
