...
public class BasicPerformanceBioReactorRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceBioReactorMenu, BasicPerformanceBioReactorRecipe> {
    ...
    public BasicPerformanceBioReactorRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicPerformanceBioReactorRecipe recipe, boolean maxTransfer) {
