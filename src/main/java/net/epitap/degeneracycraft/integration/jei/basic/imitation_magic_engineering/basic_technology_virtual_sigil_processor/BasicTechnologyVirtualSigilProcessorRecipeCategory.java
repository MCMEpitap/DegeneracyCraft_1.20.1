...
public class BasicTechnologyVirtualSigilProcessorRecipeCategory implements IRecipeCategory<BasicTechnologyVirtualSigilProcessorRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_basic_technology_virtual_sigil_processor");
    }
    ...
    @Override
    public void draw(BasicTechnologyVirtualSigilProcessorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyVirtualSigilProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyVirtualSigilProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyVirtualSigilProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
