...
public class FineParticleAdsorberRecipe implements Recipe<SimpleContainer> {
    ...
    public FineParticleAdsorberRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return FineParticleAdsorberRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return FineParticleAdsorberRecipe.Type.INSTANCE;
    }
    ...
    public static class Serializer implements RecipeSerializer<FineParticleAdsorberRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "fine_particle_adsorber_recipe");

        @Override
        public FineParticleAdsorberRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new FineParticleAdsorberRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable FineParticleAdsorberRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, FineParticleAdsorberRecipe recipe) {
