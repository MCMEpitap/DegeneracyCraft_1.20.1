...
public class BasicPerformanceRockCrasherRecipeCategory implements IRecipeCategory<BasicPerformanceRockCrasherRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_basic_performance_rock_crasher");
    }
    ...
    @Override
    public void draw(BasicPerformanceRockCrasherRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceRockCrasherRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceRockCrasherRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceRockCrasherRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
