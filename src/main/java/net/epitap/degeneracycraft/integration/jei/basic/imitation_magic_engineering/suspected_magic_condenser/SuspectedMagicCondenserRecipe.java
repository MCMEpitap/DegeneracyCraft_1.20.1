...
public class SuspectedMagicCondenserRecipe implements Recipe<SimpleContainer> {
    ...
    public SuspectedMagicCondenserRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return SuspectedMagicCondenserRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return SuspectedMagicCondenserRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<SuspectedMagicCondenserRecipe> {
        public static final SuspectedMagicCondenserRecipe.Type INSTANCE = new SuspectedMagicCondenserRecipe.Type();
        public static final String ID = "suspected_magic_condenser_recipe";
    }

    public static class Serializer implements RecipeSerializer<SuspectedMagicCondenserRecipe> {
        public static final SuspectedMagicCondenserRecipe.Serializer INSTANCE = new SuspectedMagicCondenserRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "suspected_magic_condenser_recipe");

        @Override
        public SuspectedMagicCondenserRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new SuspectedMagicCondenserRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable SuspectedMagicCondenserRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, SuspectedMagicCondenserRecipe recipe) {
