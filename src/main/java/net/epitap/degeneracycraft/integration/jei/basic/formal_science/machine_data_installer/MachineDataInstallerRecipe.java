...
public class MachineDataInstallerRecipe implements Recipe<SimpleContainer> {
    ...
    public MachineDataInstallerRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return MachineDataInstallerRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return MachineDataInstallerRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<MachineDataInstallerRecipe> {
        public static final MachineDataInstallerRecipe.Type INSTANCE = new MachineDataInstallerRecipe.Type();
        public static final String ID = "machine_data_installer_recipe";
    }

    public static class Serializer implements RecipeSerializer<MachineDataInstallerRecipe> {
        public static final MachineDataInstallerRecipe.Serializer INSTANCE = new MachineDataInstallerRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "machine_data_installer_recipe");

        @Override
        public MachineDataInstallerRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MachineDataInstallerRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable MachineDataInstallerRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, MachineDataInstallerRecipe recipe) {
