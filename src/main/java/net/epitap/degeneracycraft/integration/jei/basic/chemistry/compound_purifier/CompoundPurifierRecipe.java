...
public class CompoundPurifierRecipe implements Recipe<SimpleContainer> {
    ...
    public CompoundPurifierRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return CompoundPurifierRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return CompoundPurifierRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<CompoundPurifierRecipe> {
        public static final CompoundPurifierRecipe.Type INSTANCE = new CompoundPurifierRecipe.Type();
        public static final String ID = "compound_purifier_recipe";
    }

    public static class Serializer implements RecipeSerializer<CompoundPurifierRecipe> {
        public static final CompoundPurifierRecipe.Serializer INSTANCE = new CompoundPurifierRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "compound_purifier_recipe");

        @Override
        public CompoundPurifierRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CompoundPurifierRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable CompoundPurifierRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, CompoundPurifierRecipe recipe) {
