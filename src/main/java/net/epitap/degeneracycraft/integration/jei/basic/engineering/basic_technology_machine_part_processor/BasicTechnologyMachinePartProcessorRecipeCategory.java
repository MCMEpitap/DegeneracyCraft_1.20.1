...
public class BasicTechnologyMachinePartProcessorRecipeCategory implements IRecipeCategory<BasicTechnologyMachinePartProcessorRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_basic_technology_machine_part_processor");
    }
    ...
    @Override
    public void draw(BasicTechnologyMachinePartProcessorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyMachinePartProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyMachinePartProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyMachinePartProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
