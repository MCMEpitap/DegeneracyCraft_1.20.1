...
public class MaterialSeparatorRecipe implements Recipe<SimpleContainer> {
    ...
    public MaterialSeparatorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return MaterialSeparatorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return MaterialSeparatorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<MaterialSeparatorRecipe> {
        public static final MaterialSeparatorRecipe.Type INSTANCE = new MaterialSeparatorRecipe.Type();
        public static final String ID = "material_separator_recipe";
    }

    public static class Serializer implements RecipeSerializer<MaterialSeparatorRecipe> {
        public static final MaterialSeparatorRecipe.Serializer INSTANCE = new MaterialSeparatorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "material_separator_recipe");

        @Override
        public MaterialSeparatorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MaterialSeparatorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable MaterialSeparatorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, MaterialSeparatorRecipe recipe) {
