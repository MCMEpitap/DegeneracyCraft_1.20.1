...
public class ElectricArcFurnaceRecipe implements Recipe<SimpleContainer> {
    ...
    public ElectricArcFurnaceRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ElectricArcFurnaceRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return ElectricArcFurnaceRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<ElectricArcFurnaceRecipe> {
        public static final ElectricArcFurnaceRecipe.Type INSTANCE = new ElectricArcFurnaceRecipe.Type();
        public static final String ID = "electric_arc_furnace_recipe";
    }

    public static class Serializer implements RecipeSerializer<ElectricArcFurnaceRecipe> {
        public static final ElectricArcFurnaceRecipe.Serializer INSTANCE = new ElectricArcFurnaceRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "electric_arc_furnace_recipe");

        @Override
        public ElectricArcFurnaceRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ElectricArcFurnaceRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable ElectricArcFurnaceRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, ElectricArcFurnaceRecipe recipe) {
