...
public class BasicPerformanceSoilPurifierRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceSoilPurifierMenu, BasicPerformanceSoilPurifierRecipe> {
    ...
    public BasicPerformanceSoilPurifierRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicPerformanceSoilPurifierRecipe recipe, boolean maxTransfer) {
