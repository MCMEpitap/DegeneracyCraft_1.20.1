...
public class BasicTechnologyMachineManufacturerRecipeTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyMachineManufacturerMenu, BasicTechnologyMachineManufacturerRecipe> {
    ...
    public BasicTechnologyMachineManufacturerRecipeTransferHandler(
    ...
    public RecipeType<BasicTechnologyMachineManufacturerRecipe> getRecipeType() {
        return BasicTechnologyMachineManufacturerRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicTechnologyMachineManufacturerRecipe recipe, boolean maxTransfer) {
