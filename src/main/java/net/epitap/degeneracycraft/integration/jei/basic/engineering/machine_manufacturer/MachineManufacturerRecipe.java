...
public class MachineManufacturerRecipe implements Recipe<SimpleContainer> {
    ...
    public MachineManufacturerRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return MachineManufacturerRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return MachineManufacturerRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<MachineManufacturerRecipe> {
        public static final MachineManufacturerRecipe.Type INSTANCE = new MachineManufacturerRecipe.Type();
        public static final String ID = "machine_manufacturer_recipe";
    }

    public static class Serializer implements RecipeSerializer<MachineManufacturerRecipe> {
        public static final MachineManufacturerRecipe.Serializer INSTANCE = new MachineManufacturerRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "machine_manufacturer_recipe");

        @Override
        public MachineManufacturerRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MachineManufacturerRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable MachineManufacturerRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, MachineManufacturerRecipe recipe) {
