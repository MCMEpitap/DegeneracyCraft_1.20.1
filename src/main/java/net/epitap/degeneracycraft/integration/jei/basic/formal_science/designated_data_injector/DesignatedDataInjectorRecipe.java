...
public class DesignatedDataInjectorRecipe implements Recipe<SimpleContainer> {
    ...
    public DesignatedDataInjectorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return DesignatedDataInjectorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return DesignatedDataInjectorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<DesignatedDataInjectorRecipe> {
        public static final DesignatedDataInjectorRecipe.Type INSTANCE = new DesignatedDataInjectorRecipe.Type();
        public static final String ID = "designated_data_injector_recipe";
    }

    public static class Serializer implements RecipeSerializer<DesignatedDataInjectorRecipe> {
        public static final DesignatedDataInjectorRecipe.Serializer INSTANCE = new DesignatedDataInjectorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "designated_data_injector_recipe");

        @Override
        public DesignatedDataInjectorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new DesignatedDataInjectorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable DesignatedDataInjectorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, DesignatedDataInjectorRecipe recipe) {
