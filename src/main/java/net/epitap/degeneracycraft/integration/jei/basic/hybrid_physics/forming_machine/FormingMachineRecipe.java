...
public class FormingMachineRecipe implements Recipe<SimpleContainer> {
    ...
    public FormingMachineRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return FormingMachineRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return FormingMachineRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<FormingMachineRecipe> {
        public static final FormingMachineRecipe.Type INSTANCE = new FormingMachineRecipe.Type();
        public static final String ID = "forming_machine_recipe";
    }

    public static class Serializer implements RecipeSerializer<FormingMachineRecipe> {
        public static final FormingMachineRecipe.Serializer INSTANCE = new FormingMachineRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "forming_machine_recipe");

        @Override
        public FormingMachineRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new FormingMachineRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable FormingMachineRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, FormingMachineRecipe recipe) {
