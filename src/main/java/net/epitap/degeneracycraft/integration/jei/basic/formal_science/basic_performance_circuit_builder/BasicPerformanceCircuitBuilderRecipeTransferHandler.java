...
public class BasicPerformanceCircuitBuilderRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCircuitBuilderMenu, BasicPerformanceCircuitBuilderRecipe> {
    ...
    public BasicPerformanceCircuitBuilderRecipeTransferHandler(
    ...
    @Override
    public RecipeType<BasicPerformanceCircuitBuilderRecipe> getRecipeType() {
        return BasicPerformanceCircuitBuilderRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicPerformanceCircuitBuilderRecipe recipe, boolean maxTransfer) {
