...
public class CellIncubatorRecipe implements Recipe<SimpleContainer> {
    ...
    public CellIncubatorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return CellIncubatorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return CellIncubatorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<CellIncubatorRecipe> {
        public static final CellIncubatorRecipe.Type INSTANCE = new CellIncubatorRecipe.Type();
        public static final String ID = "cell_incubator_recipe";
    }

    public static class Serializer implements RecipeSerializer<CellIncubatorRecipe> {
        public static final CellIncubatorRecipe.Serializer INSTANCE = new CellIncubatorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "cell_incubator_recipe");

        @Override
        public CellIncubatorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CellIncubatorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable CellIncubatorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, CellIncubatorRecipe recipe) {
