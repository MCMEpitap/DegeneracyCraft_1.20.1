...
public class BasicPerformanceCellIncubatorRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCellIncubatorMenu, BasicPerformanceCellIncubatorRecipe> {
    ...
    public BasicPerformanceCellIncubatorRecipeTransferHandler(
    ...
    private boolean hasAllItems(Player player, BasicPerformanceCellIncubatorRecipe recipe, boolean maxTransfer) {
