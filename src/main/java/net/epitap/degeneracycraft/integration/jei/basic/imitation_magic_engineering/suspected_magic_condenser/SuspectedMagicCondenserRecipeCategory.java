package net.epitap.degeneracycraft.integration.jei.basic.imitation_magic_engineering.suspected_magic_condenser;
...
public class SuspectedMagicCondenserRecipeCategory implements IRecipeCategory<SuspectedMagicCondenserRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "suspected_magic_condenser_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/imitation_magic_engineering/low_technology_suspected_magic_condenser/low_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/imitation_magic_engineering/medium_technology_suspected_magic_condenser/medium_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/imitation_magic_engineering/high_technology_suspected_magic_condenser/high_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/imitation_magic_engineering/super_technology_suspected_magic_condenser/super_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/imitation_magic_engineering/over_technology_suspected_magic_condenser/over_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/imitation_magic_engineering/ultra_technology_suspected_magic_condenser/ultra_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/imitation_magic_engineering/anti_technology_suspected_magic_condenser/anti_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/imitation_magic_engineering/imaginary_technology_suspected_magic_condenser/imaginary_technology_suspected_magic_condenser_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/imitation_magic_engineering/infinity_technology_suspected_magic_condenser/infinity_technology_suspected_magic_condenser_uid.png");
    ...
    public BasicTechnologySuspectedMagicCondenserMenu menu;

    public SuspectedMagicCondenserRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<SuspectedMagicCondenserRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_suspected_magic_condenser");
    }
    ...
    public static final RecipeType<SuspectedMagicCondenserRecipe> TYPE =
            new RecipeType<>(UID, SuspectedMagicCondenserRecipe.class);


    @Override
    public void draw(SuspectedMagicCondenserRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(SuspectedMagicCondenserRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(SuspectedMagicCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(SuspectedMagicCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(SuspectedMagicCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(SuspectedMagicCondenserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull SuspectedMagicCondenserRecipe recipe,
