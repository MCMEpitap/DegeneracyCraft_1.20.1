...
public class BasicPerformanceFineParticleAdsorberRecipeCategory implements IRecipeCategory<BasicPerformanceFineParticleAdsorberRecipe> {
    ...
    @Override
    public RecipeType<BasicPerformanceFineParticleAdsorberRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_basic_performance_fine_particle_adsorber");
    }
    ...
    @Override
    public void draw(BasicPerformanceFineParticleAdsorberRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceFineParticleAdsorberRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceFineParticleAdsorberRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicPerformanceFineParticleAdsorberRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
