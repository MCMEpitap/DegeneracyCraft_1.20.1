...
public class BasicTechnologyImitationMagicEngraverRecipeCategory implements IRecipeCategory<BasicTechnologyImitationMagicEngraverRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_basic_technology_imitation_magic_engraver");
    }
    ...
    @Override
    public void draw(BasicTechnologyImitationMagicEngraverRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicTechnologyImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicTechnologyImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(BasicTechnologyImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
