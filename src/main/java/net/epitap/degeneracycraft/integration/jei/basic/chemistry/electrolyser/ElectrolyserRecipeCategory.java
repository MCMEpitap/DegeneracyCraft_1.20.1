package net.epitap.degeneracycraft.integration.jei.basic.chemistry.electrolyser;
...
public class ElectrolyserRecipeCategory implements IRecipeCategory<ElectrolyserRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "electrolyser_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/chemistry/low_performance_electrolyser/low_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/chemistry/medium_performance_electrolyser/medium_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/chemistry/high_performance_electrolyser/high_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/chemistry/super_performance_electrolyser/super_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/chemistry/over_performance_electrolyser/over_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/chemistry/ultra_performance_electrolyser/ultra_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/chemistry/anti_performance_electrolyser/anti_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/chemistry/imaginary_performance_electrolyser/imaginary_performance_electrolyser_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/chemistry/infinity_performance_electrolyser/infinity_performance_electrolyser_uid.png");
    ...
    public BasicPerformanceElectrolyserMenu menu;

    public ElectrolyserRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_electrolyser");
    }
    ...
    public static final RecipeType<ElectrolyserRecipe> TYPE =
            new RecipeType<>(UID, ElectrolyserRecipe.class);


    @Override
    public void draw(ElectrolyserRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(ElectrolyserRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(ElectrolyserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(ElectrolyserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(ElectrolyserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(ElectrolyserRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull ElectrolyserRecipe recipe,
