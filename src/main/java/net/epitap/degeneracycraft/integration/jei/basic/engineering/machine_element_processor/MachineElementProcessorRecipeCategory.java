package net.epitap.degeneracycraft.integration.jei.basic.engineering.machine_element_processor;
...
public class MachineElementProcessorRecipeCategory implements IRecipeCategory<MachineElementProcessorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "machine_element_processor_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/engineering/low_technology_machine_element_processor/low_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/engineering/medium_technology_machine_element_processor/medium_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/engineering/high_technology_machine_element_processor/high_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/engineering/super_technology_machine_element_processor/super_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/engineering/over_technology_machine_element_processor/over_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/engineering/ultra_technology_machine_element_processor/ultra_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/engineering/anti_technology_machine_element_processor/anti_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/engineering/imaginary_technology_machine_element_processor/imaginary_technology_machine_element_processor_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/engineering/infinity_technology_machine_element_processor/infinity_technology_machine_element_processor_uid.png");
    ...
    public RedstonePoweredMachineElementManufactureMachineMenu menu0;
    public BasicTechnologyMachineElementProcessorMenu menu1;

    public MachineElementProcessorRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_machine_element_processor");
    }
    ...
    public static final RecipeType<MachineElementProcessorRecipe> TYPE =
            new RecipeType<>(UID, MachineElementProcessorRecipe.class);


    @Override
    public void draw(MachineElementProcessorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(MachineElementProcessorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(MachineElementProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(MachineElementProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(MachineElementProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(MachineElementProcessorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull MachineElementProcessorRecipe recipe,
