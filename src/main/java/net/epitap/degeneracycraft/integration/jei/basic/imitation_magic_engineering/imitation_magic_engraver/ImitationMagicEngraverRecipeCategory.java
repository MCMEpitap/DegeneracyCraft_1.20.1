package net.epitap.degeneracycraft.integration.jei.basic.imitation_magic_engineering.imitation_magic_engraver;
...
public class ImitationMagicEngraverRecipeCategory implements IRecipeCategory<ImitationMagicEngraverRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "imitation_magic_engraver_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/imitation_magic_engineering/low_technology_imitation_magic_engraver/low_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/imitation_magic_engineering/medium_technology_imitation_magic_engraver/medium_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/imitation_magic_engineering/high_technology_imitation_magic_engraver/high_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/imitation_magic_engineering/super_technology_imitation_magic_engraver/super_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/imitation_magic_engineering/over_technology_imitation_magic_engraver/over_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/imitation_magic_engineering/ultra_technology_imitation_magic_engraver/ultra_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/imitation_magic_engineering/anti_technology_imitation_magic_engraver/anti_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/imitation_magic_engineering/imaginary_technology_imitation_magic_engraver/imaginary_technology_imitation_magic_engraver_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/imitation_magic_engineering/infinity_technology_imitation_magic_engraver/infinity_technology_imitation_magic_engraver_uid.png");
    ...
    public BasicTechnologyImitationMagicEngraverMenu menu;

    public ImitationMagicEngraverRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_imitation_magic_engraver");
    }
    ...
    public static final RecipeType<ImitationMagicEngraverRecipe> TYPE =
            new RecipeType<>(UID, ImitationMagicEngraverRecipe.class);


    @Override
    public void draw(ImitationMagicEngraverRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(ImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(ImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(ImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(ImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(ImitationMagicEngraverRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull ImitationMagicEngraverRecipe recipe,
