...
public class BasicPerformanceStarlightCollectorRecipeCategory implements IRecipeCategory<BasicPerformanceStarlightCollectorRecipe> {
    ...
    @Override
    public RecipeType<BasicPerformanceStarlightCollectorRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.basic_performance_starlight_collector");
    }
    ...
    @Override
    public void draw(BasicPerformanceStarlightCollectorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(BasicPerformanceStarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(BasicPerformanceStarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
...
//        guiGraphics.drawString(fontRenderer, (recipe.getRequiredEnergy() / recipe.getRequiredTime() / 20F + " FE/t"), 17, 117, 0xFFFFFF);
    ...
    protected void drawRequiredTime(BasicPerformanceStarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(BasicPerformanceStarlightCollectorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
