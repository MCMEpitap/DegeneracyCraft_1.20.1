...
public class MachinePartProcessorRecipe implements Recipe<SimpleContainer> {
    ...
    public MachinePartProcessorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return MachinePartProcessorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return MachinePartProcessorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<MachinePartProcessorRecipe> {
        public static final MachinePartProcessorRecipe.Type INSTANCE = new MachinePartProcessorRecipe.Type();
        public static final String ID = "machine_part_processor_recipe";
    }

    public static class Serializer implements RecipeSerializer<MachinePartProcessorRecipe> {
        public static final MachinePartProcessorRecipe.Serializer INSTANCE = new MachinePartProcessorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "machine_part_processor_recipe");

        @Override
        public MachinePartProcessorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MachinePartProcessorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable MachinePartProcessorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, MachinePartProcessorRecipe recipe) {
