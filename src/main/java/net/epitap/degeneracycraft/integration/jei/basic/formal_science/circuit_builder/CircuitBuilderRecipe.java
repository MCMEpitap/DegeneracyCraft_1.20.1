...
public class CircuitBuilderRecipe implements Recipe<SimpleContainer> {
    ...
    public CircuitBuilderRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return CircuitBuilderRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return CircuitBuilderRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<CircuitBuilderRecipe> {
        public static final CircuitBuilderRecipe.Type INSTANCE = new CircuitBuilderRecipe.Type();
        public static final String ID = "circuit_builder_recipe";
    }

    public static class Serializer implements RecipeSerializer<CircuitBuilderRecipe> {
        public static final CircuitBuilderRecipe.Serializer INSTANCE = new CircuitBuilderRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "circuit_builder_recipe");

        @Override
        public CircuitBuilderRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CircuitBuilderRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable CircuitBuilderRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, CircuitBuilderRecipe recipe) {
