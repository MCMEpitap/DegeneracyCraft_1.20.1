package net.epitap.degeneracycraft.integration.jei.basic.biology.cell_incubator;
...
public class CellIncubatorRecipeCategory implements IRecipeCategory<CellIncubatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "cell_incubator_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/biology/low_performance_cell_incubator/low_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/biology/medium_performance_cell_incubator/medium_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/biology/high_performance_cell_incubator/high_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/biology/super_performance_cell_incubator/super_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/biology/over_performance_cell_incubator/over_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/biology/ultra_performance_cell_incubator/ultra_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/biology/anti_performance_cell_incubator/anti_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/biology/imaginary_performance_cell_incubator/imaginary_performance_cell_incubator_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/biology/infinity_performance_cell_incubator/infinity_performance_cell_incubator_uid.png");
    ...
    public BasicPerformanceCellIncubatorMenu menu;

    public CellIncubatorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<CellIncubatorRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_cell_incubator");
    }
    ...
    public static final RecipeType<CellIncubatorRecipe> TYPE =
            new RecipeType<>(UID, CellIncubatorRecipe.class);


    @Override
    public void draw(CellIncubatorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(CellIncubatorRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(CellIncubatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(CellIncubatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(CellIncubatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(CellIncubatorRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull CellIncubatorRecipe recipe,
