...
public class BasicPerformanceElectricArcFurnaceRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceElectricArcFurnaceMenu, BasicPerformanceElectricArcFurnaceRecipe> {
    ...
    public BasicPerformanceElectricArcFurnaceRecipeTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceElectricArcFurnaceMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceElectricArcFurnaceMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_MENU.get());
    }

    @Override
    public RecipeType<BasicPerformanceElectricArcFurnaceRecipe> getRecipeType() {
        return BasicPerformanceElectricArcFurnaceRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicPerformanceElectricArcFurnaceRecipe recipe, boolean maxTransfer) {
