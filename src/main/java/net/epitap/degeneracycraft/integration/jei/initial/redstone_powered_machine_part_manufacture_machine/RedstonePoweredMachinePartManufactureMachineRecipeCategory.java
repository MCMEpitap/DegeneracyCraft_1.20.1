...
public class RedstonePoweredMachinePartManufactureMachineRecipeCategory implements IRecipeCategory<RedstonePoweredMachinePartManufactureMachineRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_redstone_powered_machine_part_manufacture_machine");
    }
    @Override
    ...
    @Override
    public void draw(RedstonePoweredMachinePartManufactureMachineRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        drawPhase(stack);
    ...
    protected void drawRequiredEnergy(RedstonePoweredMachinePartManufactureMachineRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(RedstonePoweredMachinePartManufactureMachineRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(RedstonePoweredMachinePartManufactureMachineRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
