...
public class BasicPerformanceCompoundPurifierRecipeTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCompoundPurifierMenu, BasicPerformanceCompoundPurifierRecipe> {
    ...
    public BasicPerformanceCompoundPurifierRecipeTransferHandler(
    ...
    @Override
    public RecipeType<BasicPerformanceCompoundPurifierRecipe> getRecipeType() {
        return BasicPerformanceCompoundPurifierRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BasicPerformanceCompoundPurifierRecipe recipe, boolean maxTransfer) {
