...
public class RedstonePoweredMachinePartManufactureMachineRecipeTransferHandler
        implements IRecipeTransferHandler<RedstonePoweredMachinePartManufactureMachineMenu, RedstonePoweredMachinePartManufactureMachineRecipe> {
    ...
    public RedstonePoweredMachinePartManufactureMachineRecipeTransferHandler(
    ...
    @Override
    public Class<RedstonePoweredMachinePartManufactureMachineMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<RedstonePoweredMachinePartManufactureMachineMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.REDSTONE_POWERED_MACHINE_PART_MANUFACTURE_MACHINE_MENU.get());
    }

    @Override
    public RecipeType<RedstonePoweredMachinePartManufactureMachineRecipe> getRecipeType() {
        return RedstonePoweredMachinePartManufactureMachineRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, RedstonePoweredMachinePartManufactureMachineRecipe recipe, boolean maxTransfer) {
