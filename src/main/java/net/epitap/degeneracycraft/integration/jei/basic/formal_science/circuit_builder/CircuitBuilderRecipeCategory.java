package net.epitap.degeneracycraft.integration.jei.basic.formal_science.circuit_builder;
...
public class CircuitBuilderRecipeCategory implements IRecipeCategory<CircuitBuilderRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Degeneracycraft.MOD_ID, "circuit_builder_recipe");
    ...
    public final static ResourceLocation TEXTURE2 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/low/formal_science/low_performance_circuit_builder/low_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE3 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/medium/formal_science/medium_performance_circuit_builder/medium_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE4 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/high/formal_science/high_performance_circuit_builder/high_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE5 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/super/formal_science/super_performance_circuit_builder/super_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE6 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/over/formal_science/over_performance_circuit_builder/over_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE7 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/ultra/formal_science/ultra_performance_circuit_builder/ultra_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE8 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/anti/formal_science/anti_performance_circuit_builder/anti_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE9 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/imaginary/formal_science/imaginary_performance_circuit_builder/imaginary_performance_circuit_builder_uid.png");
    public final static ResourceLocation TEXTURE10 =
            new ResourceLocation(Degeneracycraft.MOD_ID, "textures/gui/infinity/formal_science/infinity_performance_circuit_builder/infinity_performance_circuit_builder_uid.png");
    ...
    public BasicPerformanceCircuitBuilderMenu menu;

    public CircuitBuilderRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<CircuitBuilderRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.degeneracycraft_circuit_builder");
    }
    ...
    public static final RecipeType<CircuitBuilderRecipe> TYPE =
            new RecipeType<>(UID, CircuitBuilderRecipe.class);


    @Override
    public void draw(CircuitBuilderRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    protected void drawPhase(CircuitBuilderRecipe recipe, GuiGraphics guiGraphics) {
    ...
    protected void drawRequiredEnergy(CircuitBuilderRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredEnergyUsage(CircuitBuilderRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredTime(CircuitBuilderRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    protected void drawRequiredCondition(CircuitBuilderRecipe recipe, GuiGraphics guiGraphics) {
        Minecraft minecraft = Minecraft.getInstance();
        Font fontRenderer = minecraft.font;
    ...
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder,
                          @Nonnull CircuitBuilderRecipe recipe,
