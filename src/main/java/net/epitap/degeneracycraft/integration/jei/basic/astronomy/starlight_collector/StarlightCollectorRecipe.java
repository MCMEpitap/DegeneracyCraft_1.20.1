...
public class StarlightCollectorRecipe implements Recipe<SimpleContainer> {
    ...
    public StarlightCollectorRecipe(ResourceLocation id, float energy, float time, int phase,
    ...
    public RecipeSerializer<?> getSerializer() {
        return StarlightCollectorRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return StarlightCollectorRecipe.Type.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<StarlightCollectorRecipe> {
        public static final StarlightCollectorRecipe.Type INSTANCE = new StarlightCollectorRecipe.Type();
        public static final String ID = "starlight_collector_recipe";
    }

    public static class Serializer implements RecipeSerializer<StarlightCollectorRecipe> {
        public static final StarlightCollectorRecipe.Serializer INSTANCE = new StarlightCollectorRecipe.Serializer();

        public static final ResourceLocation ID =
                new ResourceLocation(Degeneracycraft.MOD_ID, "starlight_collector_recipe");

        @Override
        public StarlightCollectorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new StarlightCollectorRecipe(id, energy, time, phase, inputs, outputs);
        }

        @Override
        public @Nullable StarlightCollectorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, StarlightCollectorRecipe recipe) {
