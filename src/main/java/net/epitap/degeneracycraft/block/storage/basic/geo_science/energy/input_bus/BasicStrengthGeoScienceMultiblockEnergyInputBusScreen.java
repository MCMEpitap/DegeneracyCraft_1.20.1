...
public class BasicStrengthGeoScienceMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthGeoScienceMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/geo_science/basic_strength_geo_science_multiblock_energy_input_bus/basic_strength_geo_science_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthGeoScienceMultiblockEnergyInputBusScreen(
            BasicStrengthGeoScienceMultiblockEnergyInputBusMenu menu,
