...
public class BasicStrengthBiologyMultiblockEnergyOutputBusScreen
        extends AbstractContainerScreen<BasicStrengthBiologyMultiblockEnergyOutputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/biology/basic_strength_biology_multiblock_energy_output_bus/basic_strength_biology_multiblock_energy_output_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthBiologyMultiblockEnergyOutputBusScreen(
            BasicStrengthBiologyMultiblockEnergyOutputBusMenu menu,
