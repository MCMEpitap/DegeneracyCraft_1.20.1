...
public class BasicStrengthDynamicEnergeticsMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthDynamicEnergeticsMultiblockEnergyStorageMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/dynamic_energetics/basic_strength_dynamic_energetics_multiblock_energy_storage/basic_strength_dynamic_energetics_multiblock_energy_storage_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthDynamicEnergeticsMultiblockEnergyStorageScreen(
            BasicStrengthDynamicEnergeticsMultiblockEnergyStorageMenu menu,
