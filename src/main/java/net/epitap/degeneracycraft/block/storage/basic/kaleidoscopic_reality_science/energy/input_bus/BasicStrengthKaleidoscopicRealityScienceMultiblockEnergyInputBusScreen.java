...
public class BasicStrengthKaleidoscopicRealityScienceMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthKaleidoscopicRealityScienceMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/kaleidoscopic_reality_science/basic_strength_kaleidoscopic_reality_science_multiblock_energy_input_bus/basic_strength_kaleidoscopic_reality_science_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthKaleidoscopicRealityScienceMultiblockEnergyInputBusScreen(
            BasicStrengthKaleidoscopicRealityScienceMultiblockEnergyInputBusMenu menu,
