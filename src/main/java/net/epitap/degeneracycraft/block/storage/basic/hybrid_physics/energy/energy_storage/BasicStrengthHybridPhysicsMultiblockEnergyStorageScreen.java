package net.epitap.degeneracycraft.block.storage.basic.hybrid_physics.energy.energy_storage;
...
public class BasicStrengthHybridPhysicsMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthHybridPhysicsMultiblockEnergyStorageMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/hybrid_physics/basic_strength_hybrid_physics_multiblock_energy_storage/basic_strength_hybrid_physics_multiblock_energy_storage_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthHybridPhysicsMultiblockEnergyStorageScreen(
            BasicStrengthHybridPhysicsMultiblockEnergyStorageMenu menu,
