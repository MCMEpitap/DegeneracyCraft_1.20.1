package net.epitap.degeneracycraft.block.storage.basic.chemistry.energy.output_bus;
...
public class BasicStrengthChemistryMultiblockEnergyOutputBusScreen
        extends AbstractContainerScreen<BasicStrengthChemistryMultiblockEnergyOutputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/chemistry/basic_strength_chemistry_multiblock_energy_output_bus/basic_strength_chemistry_multiblock_energy_output_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthChemistryMultiblockEnergyOutputBusScreen(
            BasicStrengthChemistryMultiblockEnergyOutputBusMenu menu,
