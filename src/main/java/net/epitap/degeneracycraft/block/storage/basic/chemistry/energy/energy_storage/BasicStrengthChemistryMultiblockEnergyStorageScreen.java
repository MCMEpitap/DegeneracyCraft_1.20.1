package net.epitap.degeneracycraft.block.storage.basic.chemistry.energy.energy_storage;
...
public class BasicStrengthChemistryMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthChemistryMultiblockEnergyStorageMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/chemistry/basic_strength_chemistry_multiblock_energy_storage/basic_strength_chemistry_multiblock_energy_storage_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthChemistryMultiblockEnergyStorageScreen(
            BasicStrengthChemistryMultiblockEnergyStorageMenu menu,
