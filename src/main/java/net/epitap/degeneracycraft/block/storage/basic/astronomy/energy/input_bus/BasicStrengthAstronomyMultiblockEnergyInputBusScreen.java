package net.epitap.degeneracycraft.block.storage.basic.astronomy.energy.input_bus;
...
public class BasicStrengthAstronomyMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthAstronomyMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/astronomy/basic_strength_astronomy_multiblock_energy_input_bus/basic_strength_astronomy_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthAstronomyMultiblockEnergyInputBusScreen(
            BasicStrengthAstronomyMultiblockEnergyInputBusMenu menu,
