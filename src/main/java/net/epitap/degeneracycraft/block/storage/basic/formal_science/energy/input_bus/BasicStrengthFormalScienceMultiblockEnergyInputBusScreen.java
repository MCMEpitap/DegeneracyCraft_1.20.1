package net.epitap.degeneracycraft.block.storage.basic.formal_science.energy.input_bus;
...
public class BasicStrengthFormalScienceMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthFormalScienceMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/formal_science/basic_strength_formal_science_multiblock_energy_input_bus/basic_strength_formal_science_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthFormalScienceMultiblockEnergyInputBusScreen(
            BasicStrengthFormalScienceMultiblockEnergyInputBusMenu menu,
