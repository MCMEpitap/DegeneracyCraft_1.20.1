...
public class BasicStrengthHybridPhysicsMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthHybridPhysicsMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/hybrid_physics/basic_strength_hybrid_physics_multiblock_energy_input_bus/basic_strength_hybrid_physics_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthHybridPhysicsMultiblockEnergyInputBusScreen(
            BasicStrengthHybridPhysicsMultiblockEnergyInputBusMenu menu,
