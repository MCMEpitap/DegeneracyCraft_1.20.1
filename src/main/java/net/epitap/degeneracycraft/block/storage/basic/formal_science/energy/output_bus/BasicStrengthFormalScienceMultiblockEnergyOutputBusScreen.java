...
public class BasicStrengthFormalScienceMultiblockEnergyOutputBusScreen
        extends AbstractContainerScreen<BasicStrengthFormalScienceMultiblockEnergyOutputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/formal_science/basic_strength_formal_science_multiblock_energy_output_bus/basic_strength_formal_science_multiblock_energy_output_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthFormalScienceMultiblockEnergyOutputBusScreen(
            BasicStrengthFormalScienceMultiblockEnergyOutputBusMenu menu,
