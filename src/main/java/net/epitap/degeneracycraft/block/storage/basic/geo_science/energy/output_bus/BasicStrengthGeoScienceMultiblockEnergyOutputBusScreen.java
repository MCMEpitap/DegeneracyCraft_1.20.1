...
public class BasicStrengthGeoScienceMultiblockEnergyOutputBusScreen
        extends AbstractContainerScreen<BasicStrengthGeoScienceMultiblockEnergyOutputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/geo_science/basic_strength_geo_science_multiblock_energy_output_bus/basic_strength_geo_science_multiblock_energy_output_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthGeoScienceMultiblockEnergyOutputBusScreen(
            BasicStrengthGeoScienceMultiblockEnergyOutputBusMenu menu,
