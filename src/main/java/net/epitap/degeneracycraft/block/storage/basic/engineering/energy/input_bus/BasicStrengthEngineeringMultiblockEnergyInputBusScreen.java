package net.epitap.degeneracycraft.block.storage.basic.engineering.energy.input_bus;
...
public class BasicStrengthEngineeringMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthEngineeringMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/engineering/basic_strength_engineering_multiblock_energy_input_bus/basic_strength_engineering_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthEngineeringMultiblockEnergyInputBusScreen(
            BasicStrengthEngineeringMultiblockEnergyInputBusMenu menu,
