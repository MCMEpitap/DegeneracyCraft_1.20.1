package net.epitap.degeneracycraft.block.storage.basic.engineering.energy.energy_storage;
...
public class BasicStrengthEngineeringMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthEngineeringMultiblockEnergyStorageMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/engineering/basic_strength_engineering_multiblock_energy_storage/basic_strength_engineering_multiblock_energy_storage_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthEngineeringMultiblockEnergyStorageScreen(
            BasicStrengthEngineeringMultiblockEnergyStorageMenu menu,
