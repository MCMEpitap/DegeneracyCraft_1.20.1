...
public class BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageScreen extends AbstractContainerScreen<BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/imitation_magic_engineering/basic_strength_imitation_magic_engineering_multiblock_energy_storage/basic_strength_imitation_magic_engineering_multiblock_energy_storage_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageScreen(
            BasicStrengthImitationMagicEngineeringMultiblockEnergyStorageMenu menu,
