...
public class BasicStrengthJenithVoidScienceMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthJenithVoidScienceMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/jenith_void_science/basic_strength_jenith_void_science_multiblock_energy_input_bus/basic_strength_jenith_void_science_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthJenithVoidScienceMultiblockEnergyInputBusScreen(
            BasicStrengthJenithVoidScienceMultiblockEnergyInputBusMenu menu,
