...
public class BasicStrengthBiologyMultiblockEnergyInputBusScreen
        extends AbstractContainerScreen<BasicStrengthBiologyMultiblockEnergyInputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/biology/basic_strength_biology_multiblock_energy_input_bus/basic_strength_biology_multiblock_energy_input_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthBiologyMultiblockEnergyInputBusScreen(
            BasicStrengthBiologyMultiblockEnergyInputBusMenu menu,
