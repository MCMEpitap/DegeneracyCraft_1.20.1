...
public class BasicStrengthEngineeringMultiblockEnergyOutputBusScreen
        extends AbstractContainerScreen<BasicStrengthEngineeringMultiblockEnergyOutputBusMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Degeneracycraft.MOD_ID,
                    "textures/gui/multiblock/basic/engineering/basic_strength_engineering_multiblock_energy_output_bus/basic_strength_engineering_multiblock_energy_output_bus_gui.png");

    private MultiblockEnergyStorageInfoArea energyInfoArea;

    public BasicStrengthEngineeringMultiblockEnergyOutputBusScreen(
            BasicStrengthEngineeringMultiblockEnergyOutputBusMenu menu,
