...
public class TestMachineMenu extends AbstractContainerMenu {
    ...
    public TestMachineMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(DCMenuTypes.TEST_MACHINE_MENU.get(), id);
        blockEntity = (TestMachineBlockEntity) entity;
    ...
    public TestMachineBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DCBlocks.TEST_MACHINE_BLOCK.get());
    }
