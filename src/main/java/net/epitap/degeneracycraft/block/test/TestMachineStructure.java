...
public class TestMachineStructure {
    ...
    public static boolean isFormed(Level level, BlockPos pos, BlockState state, TestMachineBlockEntity blockEntity) {
        Direction facing = state.getValue(TestMachineBlock.FACING);
    ...
    public static boolean isPowered1(Level level, BlockPos pos, BlockState state, TestMachineBlockEntity blockEntity) {
        Direction facing = state.getValue(TestMachineBlock.FACING);
        BlockPos basePos = blockEntity.getBlockPos();
    ...
    public static void hologram(Level level, BlockPos pos, BlockState state, TestMachineBlockEntity blockEntity) {
