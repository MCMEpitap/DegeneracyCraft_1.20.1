...
public class BasicTechnologyVirtualSigilProcessorTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyVirtualSigilProcessorMenu, VirtualSigilProcessorRecipe> {
    ...
    public BasicTechnologyVirtualSigilProcessorTransferHandler(
    ...
    public RecipeType<VirtualSigilProcessorRecipe> getRecipeType() {
        return VirtualSigilProcessorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, VirtualSigilProcessorRecipe recipe, boolean maxTransfer) {
