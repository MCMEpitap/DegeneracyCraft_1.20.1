...
public class BasicPowerSteamGeneratorScreen extends AbstractContainerScreen<BasicPowerSteamGeneratorMenu> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int pMouseX, int pMouseY) {
        ...
        if (menu.getHologramLevel() == 1) {
            guiGraphics.drawCenteredString(this.font, Component.translatable(menu.blockEntity.MACHINE_OUTPUT_POWERED_0 + " FE/t"),
                    125, 45, 0xffffff);
            guiGraphics.drawCenteredString(this.font, Component.translatable("screen." + "degeneracycraft_machine" + ".modifier_3"),
                    80, 11, 0xffffff);
            guiGraphics.drawCenteredString(this.font, "Lv.1",
                    80, 47, 0xFF0000);
        } else if (menu.getHologramLevel() == 0) {
            guiGraphics.drawCenteredString(this.font, Component.translatable(menu.blockEntity.MACHINE_OUTPUT_FORMED + " FE/t"),
                    125, 45, 0xffffff);
            guiGraphics.drawCenteredString(this.font, Component.translatable("screen." + "degeneracycraft_machine" + ".modifier_2"),
                    80, 11, 0xffffff);
            guiGraphics.drawCenteredString(this.font, "ON",
                    80, 47, 0xFFFFFF);
        } else {
            guiGraphics.drawCenteredString(this.font, Component.translatable(menu.blockEntity.MACHINE_OUTPUT + " FE/t"),
                    125, 45, 0xffffff);
            guiGraphics.drawCenteredString(this.font, Component.translatable("screen." + "degeneracycraft_machine" + ".modifier_1"),
                    80, 11, 0xffffff);
        ...
        renderBurnTimeTooltips(guiGraphics, pMouseX, pMouseY, x, y);
        renderWaterTimeTooltips(guiGraphics, pMouseX, pMouseY, x, y);
    ...
    private void renderPowerOutputTooltips(GuiGraphics guiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if (isMouseAboveArea(pMouseX, pMouseY, x, y, 100, 43, 48, 10))
            guiGraphics.renderTooltip(this.font, this.PowerOutputTooltips(),
    ...
    public List<Component> PowerModifierTooltips() {
        if (menu.getMultiblockLevel() == 1) {
            return List.of(Component.translatable("tooltip." + "degeneracycraft" + ".power_modifier_3"));
        } else if (menu.getMultiblockLevel() == 0) {
            return List.of(Component.translatable("tooltip." + "degeneracycraft" + ".power_modifier_2"));
        }
        return List.of(Component.translatable("tooltip." + "degeneracycraft" + ".power_modifier_1"));
    }
    ...
    private void renderBurnTimeTooltips(GuiGraphics guiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if (isMouseAboveArea(pMouseX, pMouseY, x, y, 100, 23, 48, 10))
            guiGraphics.renderTooltip(this.font, this.BurnTimeTooltips(),
                    Optional.empty(), pMouseX - x, pMouseY - y);
    }
    ...
    private void renderWaterTimeTooltips(GuiGraphics guiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if (isMouseAboveArea(pMouseX, pMouseY, x, y, 42, 26, 18, 18))
            guiGraphics.renderTooltip(this.font, this.WaterTimeTooltips(),
                    Optional.empty(), pMouseX - x, pMouseY - y);
    }
