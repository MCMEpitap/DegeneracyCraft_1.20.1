...
public class BasicTechnologyElectromagneticInductorTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyElectromagneticInductorMenu, ElectromagneticInductorRecipe> {
    ...
    public BasicTechnologyElectromagneticInductorTransferHandler(
    ...
    public RecipeType<ElectromagneticInductorRecipe> getRecipeType() {
        return ElectromagneticInductorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, ElectromagneticInductorRecipe recipe, boolean maxTransfer) {
