package net.epitap.degeneracycraft.block.machine.basic.geo_science.basic_performance_ore_sorter;
...
public class BasicPerformanceOreSorterTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceOreSorterMenu, OreSorterRecipe> {
    ...
    public BasicPerformanceOreSorterTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceOreSorterMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceOreSorterMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_ORE_SORTER_MENU.get());
    }

    @Override
    public RecipeType<OreSorterRecipe> getRecipeType() {
        return OreSorterRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, OreSorterRecipe recipe, boolean maxTransfer) {
