package net.epitap.degeneracycraft.block.machine.basic.biology.basic_performance_crop_cultivator;
...
public class BasicPerformanceCropCultivatorTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCropCultivatorMenu, CropCultivatorRecipe> {
    ...
    public BasicPerformanceCropCultivatorTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceCropCultivatorMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceCropCultivatorMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_CROP_CULTIVATOR_MENU.get());
    }

    @Override
    public RecipeType<CropCultivatorRecipe> getRecipeType() {
        return CropCultivatorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, CropCultivatorRecipe recipe, boolean maxTransfer) {
