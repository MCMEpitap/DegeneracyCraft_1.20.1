package net.epitap.degeneracycraft.block.machine.basic.hybrid_physics.basic_performance_material_separator;
...
public class BasicPerformanceMaterialSeparatorTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceMaterialSeparatorMenu, MaterialSeparatorRecipe> {
    ...
    public BasicPerformanceMaterialSeparatorTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceMaterialSeparatorMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceMaterialSeparatorMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_MATERIAL_SEPARATOR_MENU.get());
    }

    @Override
    public RecipeType<MaterialSeparatorRecipe> getRecipeType() {
        return MaterialSeparatorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, MaterialSeparatorRecipe recipe, boolean maxTransfer) {
    ...
    public @Nullable IRecipeTransferError transferRecipe(
            ...
            MaterialSeparatorRecipe recipe,
