package net.epitap.degeneracycraft.block.machine.basic.geo_science.basic_performance_rock_crasher;
...
Component.translatable("screen." + "degeneracycraft" + ".phase1"),
                15, 67, 0xFFFFFF);
...
"Stop!",
        ...
        renderChance1Tooltips(guiGraphics, pMouseX, pMouseY, x, y);
        renderChance2Tooltips(guiGraphics, pMouseX, pMouseY, x, y);
    }
    ...
    private void renderChance1Tooltips(GuiGraphics guiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if (isMouseAboveArea(pMouseX, pMouseY, x, y, 116, 7, 18, 18))
            guiGraphics.renderTooltip(this.font, this.Chance1Tooltips(),
                    Optional.empty(), pMouseX - x, pMouseY - y);
    }

    public List<Component> Chance1Tooltips() {
        return List.of(Component.translatable("tooltip." + "degeneracycraft" + ".material" + ".chance" + "50"));
    }

    private void renderChance2Tooltips(GuiGraphics guiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if (isMouseAboveArea(pMouseX, pMouseY, x, y, 134, 7, 18, 18))
            guiGraphics.renderTooltip(this.font, this.Chance2Tooltips(),
                    Optional.empty(), pMouseX - x, pMouseY - y);
    }

    public List<Component> Chance2Tooltips() {
        return List.of(Component.translatable("tooltip." + "degeneracycraft" + ".material" + ".chance" + "25"));
    }
