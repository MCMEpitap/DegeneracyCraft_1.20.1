package net.epitap.degeneracycraft.block.machine.basic.biology.basic_performance_cell_incubator;
...
public class BasicPerformanceCellIncubatorTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCellIncubatorMenu, CellIncubatorRecipe> {
    ...
    public BasicPerformanceCellIncubatorTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceCellIncubatorMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceCellIncubatorMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_CELL_INCUBATOR_MENU.get());
    }

    @Override
    public RecipeType<CellIncubatorRecipe> getRecipeType() {
        return CellIncubatorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, CellIncubatorRecipe recipe, boolean maxTransfer) {
