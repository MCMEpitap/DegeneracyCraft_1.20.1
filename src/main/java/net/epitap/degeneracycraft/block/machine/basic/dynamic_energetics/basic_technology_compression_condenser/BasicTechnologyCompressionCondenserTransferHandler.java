package net.epitap.degeneracycraft.block.machine.basic.dynamic_energetics.basic_technology_compression_condenser;
...
public class BasicTechnologyCompressionCondenserTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyCompressionCondenserMenu, CompressionCondenserRecipe> {
    ...
    public BasicTechnologyCompressionCondenserTransferHandler(
    ...
    public RecipeType<CompressionCondenserRecipe> getRecipeType() {
        return CompressionCondenserRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, CompressionCondenserRecipe recipe, boolean maxTransfer) {
