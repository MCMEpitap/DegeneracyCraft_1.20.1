package net.epitap.degeneracycraft.block.machine.basic.hybrid_physics.basic_performance_electric_arc_furnace;
...
public class BasicPerformanceElectricArcFurnaceTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceElectricArcFurnaceMenu, ElectricArcFurnaceRecipe> {
    ...
    public BasicPerformanceElectricArcFurnaceTransferHandler(
    ...
    public RecipeType<ElectricArcFurnaceRecipe> getRecipeType() {
        return ElectricArcFurnaceRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, ElectricArcFurnaceRecipe recipe, boolean maxTransfer) {
