package net.epitap.degeneracycraft.block.machine.basic.engineering.basic_technology_multiblock_equipment_fabricator;
...
public class BasicTechnologyMultiblockEquipmentFabricatorTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyMultiblockEquipmentFabricatorMenu, MultiblockEquipmentFabricatorRecipe> {
    ...
    public BasicTechnologyMultiblockEquipmentFabricatorTransferHandler(
    ...
    public RecipeType<MultiblockEquipmentFabricatorRecipe> getRecipeType() {
        return MultiblockEquipmentFabricatorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, MultiblockEquipmentFabricatorRecipe recipe, boolean maxTransfer) {
    ...
    public @Nullable IRecipeTransferError transferRecipe(
            ...
            MultiblockEquipmentFabricatorRecipe recipe,
