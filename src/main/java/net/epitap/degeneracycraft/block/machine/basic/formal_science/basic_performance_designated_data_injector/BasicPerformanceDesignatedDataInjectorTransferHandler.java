package net.epitap.degeneracycraft.block.machine.basic.formal_science.basic_performance_designated_data_injector;
...
public class BasicPerformanceDesignatedDataInjectorTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceDesignatedDataInjectorMenu, DesignatedDataInjectorRecipe> {
    ...
    public BasicPerformanceDesignatedDataInjectorTransferHandler(
    ...
    public RecipeType<DesignatedDataInjectorRecipe> getRecipeType() {
        return DesignatedDataInjectorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, DesignatedDataInjectorRecipe recipe, boolean maxTransfer) {
