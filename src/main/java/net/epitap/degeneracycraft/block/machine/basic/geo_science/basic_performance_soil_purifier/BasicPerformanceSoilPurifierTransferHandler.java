package net.epitap.degeneracycraft.block.machine.basic.geo_science.basic_performance_soil_purifier;
...
public class BasicPerformanceSoilPurifierTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceSoilPurifierMenu, SoilPurifierRecipe> {
    ...
    public BasicPerformanceSoilPurifierTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceSoilPurifierMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceSoilPurifierMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_SOIL_PURIFIER_MENU.get());
    }

    @Override
    public RecipeType<SoilPurifierRecipe> getRecipeType() {
        return SoilPurifierRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, SoilPurifierRecipe recipe, boolean maxTransfer) {
