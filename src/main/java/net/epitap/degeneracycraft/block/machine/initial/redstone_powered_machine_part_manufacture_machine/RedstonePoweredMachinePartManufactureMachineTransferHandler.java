...
public class RedstonePoweredMachinePartManufactureMachineTransferHandler
        implements IRecipeTransferHandler<RedstonePoweredMachinePartManufactureMachineMenu, MachinePartProcessorRecipe> {
    ...
    public RedstonePoweredMachinePartManufactureMachineTransferHandler(
    ...
    public RecipeType<MachinePartProcessorRecipe> getRecipeType() {
        return MachinePartProcessorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, MachinePartProcessorRecipe recipe, boolean maxTransfer) {
    ...
    public @Nullable IRecipeTransferError transferRecipe(
            ...
            MachinePartProcessorRecipe recipe,
