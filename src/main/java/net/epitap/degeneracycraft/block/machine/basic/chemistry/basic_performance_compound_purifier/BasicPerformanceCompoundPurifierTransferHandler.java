package net.epitap.degeneracycraft.block.machine.basic.chemistry.basic_performance_compound_purifier;
...
public class BasicPerformanceCompoundPurifierTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCompoundPurifierMenu, CompoundPurifierRecipe> {
    ...
    public BasicPerformanceCompoundPurifierTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceCompoundPurifierMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceCompoundPurifierMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_COMPOUND_PURIFIER_MENU.get());
    }

    @Override
    public RecipeType<CompoundPurifierRecipe> getRecipeType() {
        return CompoundPurifierRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, CompoundPurifierRecipe recipe, boolean maxTransfer) {
