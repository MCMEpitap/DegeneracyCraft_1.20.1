package net.epitap.degeneracycraft.block.machine.basic.kaleidoscopic_reality_science.basic_performance_reality_phase_adjustment_machine;
...
public class BasicPerformanceRealityPhaseAdjustmentMachineTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceRealityPhaseAdjustmentMachineMenu, RealityPhaseAdjustmentMachineRecipe> {
    ...
    public BasicPerformanceRealityPhaseAdjustmentMachineTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceRealityPhaseAdjustmentMachineMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceRealityPhaseAdjustmentMachineMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_MENU.get());
    }

    @Override
    public RecipeType<RealityPhaseAdjustmentMachineRecipe> getRecipeType() {
        return RealityPhaseAdjustmentMachineRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, RealityPhaseAdjustmentMachineRecipe recipe, boolean maxTransfer) {
