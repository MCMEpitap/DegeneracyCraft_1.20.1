package net.epitap.degeneracycraft.block.machine.basic.jenith_void_science.basic_technology_void_world_coordinate_recording_machine;
...
public class BasicTechnologyVoidWorldCoordinateRecordingMachineTransferHandler
        implements IRecipeTransferHandler<BasicTechnologyVoidWorldCoordinateRecordingMachineMenu, VoidWorldCoordinateRecordingMachineRecipe> {
    ...
    public BasicTechnologyVoidWorldCoordinateRecordingMachineTransferHandler(
    ...
    public RecipeType<VoidWorldCoordinateRecordingMachineRecipe> getRecipeType() {
        return VoidWorldCoordinateRecordingMachineRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, VoidWorldCoordinateRecordingMachineRecipe recipe, boolean maxTransfer) {
    ...
    public @Nullable IRecipeTransferError transferRecipe(
            ...
            VoidWorldCoordinateRecordingMachineRecipe recipe,
