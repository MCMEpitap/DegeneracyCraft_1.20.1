...
public class BasicTechnologySuspectedMagicCondenserTransferHandler
        implements IRecipeTransferHandler<BasicTechnologySuspectedMagicCondenserMenu, SuspectedMagicCondenserRecipe> {
    ...
    public BasicTechnologySuspectedMagicCondenserTransferHandler(
    ...
    public RecipeType<SuspectedMagicCondenserRecipe> getRecipeType() {
        return SuspectedMagicCondenserRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, SuspectedMagicCondenserRecipe recipe, boolean maxTransfer) {
