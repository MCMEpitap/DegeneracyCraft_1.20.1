...
public class BasicPerformanceRockCrasherTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceRockCrasherMenu, RockCrasherRecipe> {
    ...
    public BasicPerformanceRockCrasherTransferHandler(
    ...
    public RecipeType<RockCrasherRecipe> getRecipeType() {
        return RockCrasherRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, RockCrasherRecipe recipe, boolean maxTransfer) {
