...
public class BasicPerformanceBioReactorTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceBioReactorMenu, BioReactorRecipe> {
    ...
    public BasicPerformanceBioReactorTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceBioReactorMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceBioReactorMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_BIO_REACTOR_MENU.get());
    }

    @Override
    public RecipeType<BioReactorRecipe> getRecipeType() {
        return BioReactorRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, BioReactorRecipe recipe, boolean maxTransfer) {
