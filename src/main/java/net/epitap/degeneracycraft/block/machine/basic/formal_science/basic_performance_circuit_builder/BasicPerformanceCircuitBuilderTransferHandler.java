package net.epitap.degeneracycraft.block.machine.basic.formal_science.basic_performance_circuit_builder;
...
public class BasicPerformanceCircuitBuilderTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceCircuitBuilderMenu, CircuitBuilderRecipe> {
    ...
    public BasicPerformanceCircuitBuilderTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceCircuitBuilderMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceCircuitBuilderMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_CIRCUIT_BUILDER_MENU.get());
    }

    @Override
    public RecipeType<CircuitBuilderRecipe> getRecipeType() {
        return CircuitBuilderRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, CircuitBuilderRecipe recipe, boolean maxTransfer) {
