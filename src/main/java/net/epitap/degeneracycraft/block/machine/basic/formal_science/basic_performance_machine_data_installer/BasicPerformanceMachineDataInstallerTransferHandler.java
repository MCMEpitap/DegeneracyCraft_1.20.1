package net.epitap.degeneracycraft.block.machine.basic.formal_science.basic_performance_machine_data_installer;
...
public class BasicPerformanceMachineDataInstallerTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceMachineDataInstallerMenu, MachineDataInstallerRecipe> {
    ...
    public BasicPerformanceMachineDataInstallerTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceMachineDataInstallerMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceMachineDataInstallerMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_MACHINE_DATA_INSTALLER_MENU.get());
    }

    @Override
    public RecipeType<MachineDataInstallerRecipe> getRecipeType() {
        return MachineDataInstallerRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, MachineDataInstallerRecipe recipe, boolean maxTransfer) {
    ...
    public @Nullable IRecipeTransferError transferRecipe(
            ...
            MachineDataInstallerRecipe recipe,
