package net.epitap.degeneracycraft.block.machine.basic.hybrid_physics.basic_performance_forming_machine;
...
public class BasicPerformanceFormingMachineTransferHandler
        implements IRecipeTransferHandler<BasicPerformanceFormingMachineMenu, FormingMachineRecipe> {
    ...
    public BasicPerformanceFormingMachineTransferHandler(
    ...
    @Override
    public Class<BasicPerformanceFormingMachineMenu> getContainerClass() {
        return containerClass;
    }

    @Override
    public Optional<MenuType<BasicPerformanceFormingMachineMenu>> getMenuType() {
        return Optional.of(DCMenuTypes.BASIC_PERFORMANCE_FORMING_MACHINE_MENU.get());
    }

    @Override
    public RecipeType<FormingMachineRecipe> getRecipeType() {
        return FormingMachineRecipeCategory.TYPE;
    }

    private boolean hasAllItems(Player player, FormingMachineRecipe recipe, boolean maxTransfer) {
