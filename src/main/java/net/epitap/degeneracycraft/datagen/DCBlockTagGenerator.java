...
public class DCBlockTagGenerator extends BlockTagsProvider {
    ...
    public static final TagKey<Block> BASIC_ASTRONOMY_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_astronomy_multiblocks"));
    public static final TagKey<Block> BASIC_BIOLOGY_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_biology_multiblocks"));
    public static final TagKey<Block> BASIC_CHEMISTRY_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_chemistry_multiblocks"));
    public static final TagKey<Block> BASIC_DYNAMIC_ENERGETICS_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_dynamic_energetics_multiblocks"));
    public static final TagKey<Block> BASIC_ENGINEERING_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_engineering_multiblocks"));
    public static final TagKey<Block> BASIC_FORMAL_SCIENCE_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_formal_science_multiblocks"));
    public static final TagKey<Block> BASIC_GEO_SCIENCE_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_geo_science_multiblocks"));
    public static final TagKey<Block> BASIC_HYBRID_PHYSICS_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_hybrid_physics_multiblocks"));
    public static final TagKey<Block> BASIC_IMITATION_MAGIC_ENGINEERING_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_imitation_magic_engineering_multiblocks"));
    public static final TagKey<Block> BASIC_JENITH_VOID_SCIENCE_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_jenith_void_science_multiblocks"));
    public static final TagKey<Block> BASIC_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_kaleidoscopic_reality_science_multiblocks"));

    public static final TagKey<Block> INITIAL_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"initial_machines"));

    public static final TagKey<Block> BASIC_ASTRONOMY_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_astronomy_machines"));
    public static final TagKey<Block> BASIC_BIOLOGY_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_biology_machines"));
    public static final TagKey<Block> BASIC_CHEMISTRY_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_chemistry_machines"));
    public static final TagKey<Block> BASIC_DYNAMIC_ENERGETICS_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_dynamic_energetics_machines"));
    public static final TagKey<Block> BASIC_ENGINEERING_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_engineering_machines"));
    public static final TagKey<Block> BASIC_FORMAL_SCIENCE_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_formal_science_machines"));
    public static final TagKey<Block> BASIC_GEO_SCIENCE_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_geo_science_machines"));
    public static final TagKey<Block> BASIC_HYBRID_PHYSICS_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_hybrid_physics_machines"));
    public static final TagKey<Block> BASIC_IMITATION_MAGIC_ENGINEERING_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_imitation_magic_engineering_machines"));
    public static final TagKey<Block> BASIC_JENITH_VOID_SCIENCE_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_jenith_void_science_machines"));
    public static final TagKey<Block> BASIC_KALEIDOSCOPIC_REALITY_SCIENCE_MACHINES =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_kaleidoscopic_reality_science_machines"));
    
    public static final TagKey<Block> BASIC_ASTRONOMY_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_astronomy_ability_blocks"));
    public static final TagKey<Block> BASIC_BIOLOGY_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_biology_ability_blocks"));
    public static final TagKey<Block> BASIC_CHEMISTRY_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_chemistry_ability_blocks"));
    public static final TagKey<Block> BASIC_DYNAMIC_ENERGETICS_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_dynamic_energetics_ability_blocks"));
    public static final TagKey<Block> BASIC_ENGINEERING_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_engineering_ability_blocks"));
    public static final TagKey<Block> BASIC_FORMAL_SCIENCE_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_formal_science_ability_blocks"));
    public static final TagKey<Block> BASIC_GEO_SCIENCE_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_geo_science_ability_blocks"));
    public static final TagKey<Block> BASIC_HYBRID_PHYSICS_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_hybrid_physics_ability_blocks"));
    public static final TagKey<Block> BASIC_IMITATION_MAGIC_ENGINEERING_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_imitation_magic_engineering_ability_blocks"));
    public static final TagKey<Block> BASIC_JENITH_VOID_SCIENCE_ABILITY_BLOCKS =TagKey.create(Registries.BLOCK,new ResourceLocation(Degeneracycraft.MOD_ID,"basic_jenith_void_science_ability_blocks"));
...
//                .add(DCBlocks.OVERWORLD_GRAVITATION_ORE.get());
        ...
        tag(DEGENERACYCRAFT_MULTIBLOCKS)
                ...
                .add(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_ENERGY_STORAGE_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_ITEM_STORAGE_BLOCK.get())
        ...
        tag(BASIC_ASTRONOMY_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ASTRONOMY_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
        ...
        tag(BASIC_BIOLOGY_MULTIBLOCKS)
                ...
                .add(DCBlocks.BASIC_STRENGTH_BIOLOGY_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_CHEMISTRY_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_CHEMISTRY_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_DYNAMIC_ENERGETICS_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_DYNAMIC_ENERGETICS_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_ENGINEERING_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_ENGINEERING_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_FORMAL_SCIENCE_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_FORMAL_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_GEO_SCIENCE_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_GEO_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_HYBRID_PHYSICS_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_HYBRID_PHYSICS_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_IMITATION_MAGIC_ENGINEERING_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_IMITATION_MAGIC_ENGINEERING_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_JENITH_VOID_SCIENCE_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
                ...
                .add(DCBlocks.BASIC_STRENGTH_JENITH_VOID_SCIENCE_MULTIBLOCK_ITEM_OUTPUT_PORT_BLOCK.get())
                ;
        tag(BASIC_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCKS)
                .add(DCBlocks.BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_BASE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_MACHINE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_STRUCTURE_FRAME_BLOCK.get())
                .add(DCBlocks.BASIC_STRENGTH_KALEIDOSCOPIC_REALITY_SCIENCE_MULTIBLOCK_STRUCTURE_GLASS_BLOCK.get())
        ...
        tag(INITIAL_MACHINES)
                .add(DCBlocks.REDSTONE_POWERED_MACHINE_ELEMENT_MANUFACTURE_MACHINE_BLOCK.get())
                .add(DCBlocks.REDSTONE_POWERED_MACHINE_PART_MANUFACTURE_MACHINE_BLOCK.get());
        tag(BASIC_ASTRONOMY_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_ASTRONOMICAL_TELESCOPE_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_FINE_PARTICLE_ADSORBER_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_STARLIGHT_COLLECTOR_BLOCK.get());
        tag(BASIC_BIOLOGY_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_BIO_REACTOR_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_CELL_INCUBATOR_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_CROP_CULTIVATOR_BLOCK.get());
        tag(BASIC_CHEMISTRY_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_CHEMICAL_REACTOR_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_COMPOUND_PURIFIER_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_ELECTROLYSER_BLOCK.get());
        tag(BASIC_DYNAMIC_ENERGETICS_MACHINES)
                .add(DCBlocks.BASIC_POWER_STEAM_GENERATOR_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_COMPRESSION_CONDENSER_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_ELECTROMAGNETIC_INDUCTOR_BLOCK.get());
        tag(BASIC_ENGINEERING_MACHINES)
                .add(DCBlocks.BASIC_TECHNOLOGY_MACHINE_MANUFACTURER_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_MACHINE_ELEMENT_PROCESSOR_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_MACHINE_PART_PROCESSOR_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_MULTIBLOCK_EQUIPMENT_FABRICATOR_BLOCK.get());
        tag(BASIC_FORMAL_SCIENCE_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_CIRCUIT_BUILDER_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_MACHINE_DATA_INSTALLER_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_DESIGNATED_DATA_INJECTOR_BLOCK.get());
        tag(BASIC_GEO_SCIENCE_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_ORE_SORTER_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_ROCK_CRASHER_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_SOIL_PURIFIER_BLOCK.get());
        tag(BASIC_HYBRID_PHYSICS_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_ELECTRIC_ARC_FURNACE_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_FORMING_MACHINE_BLOCK.get())
                .add(DCBlocks.BASIC_PERFORMANCE_MATERIAL_SEPARATOR_BLOCK.get());
        tag(BASIC_IMITATION_MAGIC_ENGINEERING_MACHINES)
                .add(DCBlocks.BASIC_TECHNOLOGY_IMITATION_MAGIC_ENGRAVER_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_SUSPECTED_MAGIC_CONDENSER_BLOCK.get())
                .add(DCBlocks.BASIC_TECHNOLOGY_VIRTUAL_SIGIL_PROCESSOR_BLOCK.get());
        tag(BASIC_JENITH_VOID_SCIENCE_MACHINES)
                .add(DCBlocks.BASIC_TECHNOLOGY_VOID_WORLD_COORDINATE_RECORDING_MACHINE_BLOCK.get());
        tag(BASIC_KALEIDOSCOPIC_REALITY_SCIENCE_MACHINES)
                .add(DCBlocks.BASIC_PERFORMANCE_REALITY_PHASE_ADJUSTMENT_MACHINE_BLOCK.get());
        ...
        tag(BASIC_ASTRONOMY_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_PRECISION_OBJECTIVE_LENS_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_FINE_PARTICLE_STORAGE_TANK_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_FAINT_LIGHT_RESERVER_BLOCK.get());
        tag(BASIC_BIOLOGY_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_SPEED_CULTIVATION_GREENHOUSE_BLOCK.get())
                .add(DCBlocks.BASIC_DURABILITY_INCUBATION_CONTAINER_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_GROWTH_STABILIZER_BLOCK.get());
        tag(BASIC_CHEMISTRY_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_RATE_COMPOUND_AGITATION_SYSTEM_BLOCK.get())
                .add(DCBlocks.BASIC_DURABLE_HIGH_SPPED_CHEMICAL_REACTOR_BLOCK.get())
                .add(DCBlocks.BASIC_DURABLE_EXPANDED_ELECTROLYTIC_CELL_BLOCK.get());
        tag(BASIC_DYNAMIC_ENERGETICS_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_ENDURANCE_HIGH_TEMPERATURE_COMBUSTION_CHAMBER_BLOCK.get())
                .add(DCBlocks.BASIC_PRESSURE_COMPRESSION_ASSIST_SYSTEM_BLOCK.get())
                .add(DCBlocks.BASIC_DURABLE_INSULATED_CHAMBER_BLOCK.get());
        tag(BASIC_ENGINEERING_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_EFFICIENCY_MACHINE_PROCESSING_CHAMBER_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_MACHINE_ELEMENT_PROCESSING_CHAMBER_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_MACHINE_PART_PROCESSING_CHAMBER_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_EQUIPMENT_PRODUCTION_AUXILIARY_SYSTEM_BLOCK.get());
        tag(BASIC_FORMAL_SCIENCE_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_PURITY_CIRCUIT_CLEAN_ROOM_BLOCK.get())
                .add(DCBlocks.BASIC_SPEED_DATA_READER_BLOCK.get())
                .add(DCBlocks.BASIC_SPEED_CALCULATION_AUXILIARY_WRITE_DEVICE_BLOCK.get());
        tag(BASIC_GEO_SCIENCE_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_EFFICIENCY_ORE_SORTING_FILTER_BLOCK.get())
                .add(DCBlocks.BASIC_CRASHING_BASE_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_PARTICLE_MIXING_CHAMBER_BLOCK.get());
        tag(BASIC_HYBRID_PHYSICS_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_FLOW_COOLING_SYSTEM_BLOCK.get())
                .add(DCBlocks.BASIC_PRECISION_EXTRUSION_ASSIST_SYSTEM_BLOCK.get())
                .add(DCBlocks.BASIC_DURABILITY_VIBRATION_CONTROL_BASE_BLOCK.get());
        tag(BASIC_IMITATION_MAGIC_ENGINEERING_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_OUTPUT_MYSTIC_OPTICAL_PROJECTION_DEVICE_BLOCK.get())
                .add(DCBlocks.BASIC_EFFICIENCY_SEALED_EXTRACTION_CASE_BLOCK.get())
                .add(DCBlocks.BASIC_SPEED_PATTERN_TRANSFER_SYSTEM_BLOCK.get());
        tag(BASIC_JENITH_VOID_SCIENCE_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_EFFICIENCY_VOID_INTERFERENCE_FLAME_BLOCK.get());
        tag(BASIC_KALEIDOSCOPIC_REALITY_SCIENCE_ABILITY_BLOCKS)
                .add(DCBlocks.BASIC_EFFICIENCY_PHASE_STABLE_FLAME_BLOCK.get())
        ;
        ...
        tag(TEST_BLOCKS)
                .add(DCBlocks.TEST_MACHINE_BLOCK.get())
                ;
    }
