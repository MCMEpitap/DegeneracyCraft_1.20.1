...
public class DCRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public DCRecipeProvider(PackOutput packOutput) {
        super(packOutput);
    }
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DCBlocks.REDSTONE_POWERED_MACHINE_PART_MANUFACTURE_MACHINE_BLOCK.get())
                .pattern("bgb")
                .pattern("pcp")
                .pattern("nrn")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DCBlocks.BASIC_POWER_STEAM_GENERATOR_BLOCK.get())
                .pattern("iSi")
                .pattern("TMC")
                .pattern("pBp")
                ...
                .unlockedBy("ingots/iron", InventoryChangeTrigger.TriggerInstance.hasItems(Items.IRON_INGOT))
                .save(pWriter);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DCBlocks.BASIC_TECHNOLOGY_MACHINE_MANUFACTURER_BLOCK.get())
                .pattern("RSR")
                .pattern("MDM")
                .pattern("LBL")
