...
//                .add();
        ...
        net.messageBuilder(DCEnergySyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                ...
                .consumerMainThread(DCEnergySyncS2CPacket::handle)
                .add();
        ...
        net.messageBuilder(DCItemStackSyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                ...
                .consumerMainThread(DCItemStackSyncS2CPacket::handle)
                .add();
        ...
        net.messageBuilder(DCMachineToggleC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .consumerMainThread(DCMachineToggleC2SPacket::handle)
                .add();
        ...
        net.messageBuilder(DCTransferRecipeC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
                ...
                .consumerMainThread(DCTransferRecipeC2SPacket::handle)
                .add();
